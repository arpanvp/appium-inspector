process.env.HMR_PORT=45497;process.env.HMR_HOSTNAME="localhost";// modules are defined as an array
...
class Inspector extends _react.Component {
  ...
  render() {
    ...
    let screenShotControls = /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: this.state.activeCategory === 1 ? _Inspector.default['activeCategory'] : _Inspector.default['category']
      ...
      className: this.state.activeCategory === 3 ? _Inspector.default['activeCategory'] : _Inspector.default['category']
      ...
      className: this.state.activeCategory === 4 ? _Inspector.default['activeCategory'] : _Inspector.default['category']
      ...
      className: this.state.activeCategory === 5 ? _Inspector.default['activeCategory'] : _Inspector.default['category']
