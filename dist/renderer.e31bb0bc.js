...
<<<<<<< HEAD
<<<<<<< HEAD
process.env.HMR_PORT=42211;process.env.HMR_HOSTNAME="localhost";// modules are defined as an array
=======
<<<<<<< HEAD
<<<<<<< HEAD
process.env.HMR_PORT=42641;process.env.HMR_HOSTNAME="localhost";// modules are defined as an array
=======
<<<<<<< HEAD
<<<<<<< HEAD
...
>>>>>>> 548cabee6a9d54cbe3b841c27a2caa815c5a0e9b
>>>>>>> 3fa90943ee6c3a1791f18937c0394213e7aa2f60
=======
process.env.HMR_PORT=38103;process.env.HMR_HOSTNAME="localhost";// modules are defined as an array
>>>>>>> 4ec0649 (added changes)
>>>>>>> e8af83d7bf2ea22c6f00c82c9f35afb1f034cc47
...
<<<<<<< HEAD
      ...
      onClick: () => {
        this.screenshotInteractionChange(HIDE_KEYBOARD);
        this.hideKeyboard();
      },
      type: screenshotInteractionMode === HIDE_KEYBOARD ? _AntdTypes.BUTTON.PRIMARY : _AntdTypes.BUTTON.DEFAULT,
      disabled: isGestureEditorVisible,
      className: _Inspector.default['user_actions']
    }, this.state.activeIndex === 13 && /*#__PURE__*/_react.default.createElement("span", null, "Hide Keyboard")), /*#__PURE__*/_react.default.createElement(_antd.Button, {
      onMouseOver: () => this.setActiveIndex(14),
      onMouseOut: () => this.setActiveIndex(0),
      icon: /*#__PURE__*/_react.default.createElement(_icons.FieldTimeOutlined, null),
      onClick: () => {
        this.screenshotInteractionChange(GET_DEVICE_TIME);
        this.getDeviceTime();
      },
      type: screenshotInteractionMode === GET_DEVICE_TIME ? _AntdTypes.BUTTON.PRIMARY : _AntdTypes.BUTTON.DEFAULT,
      disabled: isGestureEditorVisible,
      className: _Inspector.default['user_actions']
    }, this.state.activeIndex === 14 && /*#__PURE__*/_react.default.createElement("span", null, "Get Device Time"))));
=======
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.SCREENSHOT_INTERACTION_MODE=exports.RENDER_CENTROID_AS=exports.POINTER_TYPES=exports.INTERACTION_MODE=exports.DEFAULT_ZOOM=exports.DEFAULT_TAP=exports.DEFAULT_SWIPE=exports.DEFAULT_LONGPRESS=exports.DEFAULT_DRAG_AND_DROP=exports.COMMAND_DEFINITIONS=exports.COMMAND_ARG_TYPES=exports.APP_MODE=void 0,exports.getLocators=m,exports.isUnique=n,exports.parseCoordinates=s,exports.percentageToPixels=r,exports.pixelsToPercentage=a;var e=require("@xmldom/xmldom"),t=o(require("xpath"));function o(e){return e&&e.__esModule?e:{default:e}}function a(e,t){if(!isNaN(e))return parseFloat((e/t*100).toFixed(1),10)}function r(e,t){if(!isNaN(e))return Math.round(t*(e/100))}function s(e){let{bounds:t,x:o,y:a,width:r,height:s}=e.attributes||{};if(t){let e=t.split(/\[|\]|,/).filter(e=>""!==e);const o=parseInt(e[0],10),a=parseInt(e[2],10);return{x1:o,y1:parseInt(e[1],10),x2:a,y2:parseInt(e[3],10)}}return o?{x1:o=parseInt(o,10),y1:a=parseInt(a,10),x2:o+(r=parseInt(r,10)),y2:a+(s=parseInt(s,10))}:{}}function n(o,a,r){if(!r)return!0;const s=(new e.DOMParser).parseFromString(r);return t.default.select(`//*[@${o}="${a.replace(/"/g,"")}"]`,s).length<2}const i=[["name","accessibility id"],["content-desc","accessibility id"],["id","id"],["rntestid","id"],["resource-id","id"],["class","class name"],["type","class name"]];function m(e,t){const o={};for(let[a,r]of i){const s=e[a];s&&n(a,s,t)&&(o[r]=e[a])}return o}const d={POINTER_UP:"pointerUp",POINTER_DOWN:"pointerDown",PAUSE:"pause",POINTER_MOVE:"pointerMove"};exports.POINTER_TYPES=d;const N={POINTER_NAME:"finger1",DURATION_1:0,DURATION_2:750,BUTTON:0,ORIGIN:"viewport"};exports.DEFAULT_SWIPE=N;const p={POINTER_NAME1:"finger1",POINTER_NAME2:"finger2",POINTER_NAME3:"finger2",POINTER_NAME4:"finger2",DURATION_1:0,DURATION_2:750,BUTTON:0,ORIGIN:"viewport"};exports.DEFAULT_ZOOM=p;const g={POINTER_NAME:"finger1",DURATION_1:0,DURATION_2:100,BUTTON:0};exports.DEFAULT_TAP=g;const l={LONGPRESS_POINTER_NAME:"finger1",LONGPRESS_DURATION_1:0,LONGPRESS_DURATION_2:1e3,LONGPRESS_BUTTON:0};exports.DEFAULT_LONGPRESS=l;const c={POINTER_NAME:"finger1",DURATION_1:0,DURATION_2:750,BUTTON:0,ORIGIN:"viewport"};exports.DEFAULT_DRAG_AND_DROP=c;const h={CENTROID:"centroid",EXPAND:"expand",OVERLAP:"overlap"};exports.RENDER_CENTROID_AS=h;const T={SELECT:"select",SWIPE:"swipe",TAP:"tap",LONGPRESS:"longpress",DRAG_AND_DROP:"drag_and_drop",DOUBLE_TAP:"double tap",GESTURE:"gesture",ZOOMIN:"zoomin",SLIDE:"slide",SLIDE_SWIPE:"slide_swipe",SELECT_LONG:"select_long",SELECT_DOUBLE:"select_double",FILE_UPLOAD:"file_upload",SELECT_FILE:"select_file",EXPECTED_VALUE:"expected_value",TAKE_SCREENSHOT:"take_screenshot",SCRATCH:"scratch"};exports.SCREENSHOT_INTERACTION_MODE=T;const E={NATIVE:"native",WEB_HYBRID:"web_hybrid"};exports.APP_MODE=E;const S={STRING:"string",NUMBER:"number",BOOLEAN:"boolean"};exports.COMMAND_ARG_TYPES=S;const{STRING:O,NUMBER:A,BOOLEAN:I}=S,u={Device:{"Execute Script":{Execute:{methodName:"executeScript",args:[["executeScriptCommand",O],["jsonArgument",O]]}},"Android Activity":{"Start Activity":{methodName:"startActivity",args:[["appPackage",O],["appActivity",O],["appWaitPackage",O],["intentAction",O],["intentCategory",O],["intentFlags",O],["optionalIntentArguments",O],["dontStopAppOnReset",O]],refresh:!0},"Current Activity":{methodName:"getCurrentActivity"},"Current Package":{methodName:"getCurrentPackage"}},App:{"Install App":{methodName:"installApp",args:[["appPathOrUrl",O]]},"Is App Installed":{methodName:"isAppInstalled",args:[["appId",O]]},"Background App":{methodName:"background",args:[["timeout",A]],refresh:!0},"Activate App":{methodName:"activateApp",args:[["appId",O]],refresh:!0},"Terminate App":{methodName:"terminateApp",args:[["appId",O]],refresh:!0},"Remove App":{methodName:"removeApp",args:[["appId",O]]},"Get App Strings":{methodName:"getStrings",args:[["language",O],["stringFile",O]],refresh:!0}},Clipboard:{"Get Clipboard":{methodName:"getClipboard"},"Set Clipboard":{methodName:"setClipboard",args:[["clipboardText",O],["contentType",O],["contentLabel",O]]}},File:{"Push File":{methodName:"pushFile",args:[["pathToInstallTo",O],["fileContentString",O]]},"Pull File":{methodName:"pullFile",args:[["pathToPullFrom",O]]},"Pull Folder":{methodName:"pullFolder",args:[["folderToPullFrom",O]]}},Interaction:{Shake:{methodName:"shake"},Lock:{methodName:"lock",args:[["seconds",A]],refresh:!0},Unlock:{methodName:"unlock",refresh:!0},"Is Device Locked":{methodName:"isLocked"},"Rotate Device":{methodName:"rotateDevice",args:[["x",A],["y",A],["radius",A],["rotatation",A],["touchCount",A],["duration",A]],refresh:!0}},Keys:{"Press Key":{methodName:"pressKeyCode",args:[["keyCode",A],["metaState",A],["flags",A]],refresh:!0},"Long Press Key":{methodName:"longPressKeyCode",args:[["keyCode",A],["metaState",A],["flags",A]],refresh:!0},"Hide Keyboard":{methodName:"hideKeyboard",refresh:!0},"Is Keyboard Shown":{methodName:"isKeyboardShown"}},Network:{"Toggle Airplane Mode":{methodName:"toggleAirplaneMode"},"Toggle Data":{methodName:"toggleData"},"Toggle WiFi":{methodName:"toggleWiFi"},"Toggle Location Services":{methodName:"toggleLocationServices"},"Send SMS":{methodName:"sendSMS",args:[["phoneNumber",O],["text",O]]},"GSM Call":{methodName:"gsmCall",args:[["phoneNumber",O],["action",O]]},"GSM Signal":{methodName:"gsmSignal",args:[["signalStrengh",A]]},"GSM Voice":{methodName:"gsmVoice",args:[["state",O]]}},"Performance Data":{"Get Data":{methodName:"getPerformanceData",args:[["packageName",O],["dataType",O],["dataReadTimeout",A]]},"Get Data Types":{methodName:"getPerformanceDataTypes"}},"iOS Simulator":{"Perform Touch Id":{methodName:"touchId",args:[["shouldMatch",I]],refresh:!0},"Toggle Touch Id Enrollment":{methodName:"toggleEnrollTouchId",args:[["shouldEnroll",I]]}},System:{"Open Notifications":{methodName:"openNotifications",refresh:!0},"Get System Time":{methodName:"getDeviceTime"},"Fingerprint (Android)":{methodName:"fingerPrint",args:[["fingerPrintId",A]],refresh:!0}}},Session:{"Session Capabilities":{"Get Session Capabilities":{methodName:"getSession"}},Timeouts:{"Set Timeouts":{methodName:"setTimeouts",args:[["implicitTimeout",A],["pageLoadTimeout",A],["scriptTimeout",A]]}},Orientation:{"Get Orientation":{methodName:"getOrientation"},"Set Orientation":{methodName:"setOrientation",args:[["orientation",O]],refresh:!0}},Geolocation:{"Get Geolocation":{methodName:"getGeoLocation"},"Set Geolocation":{methodName:"setGeoLocation",args:[["latitude",A],["longitude",A],["altitude",A]]}},Logs:{"Get Log Types":{methodName:"getLogTypes"},"Get Logs":{methodName:"getLogs",args:[["logType",O]]}},Settings:{"Update Settings":{methodName:"updateSettings",args:[["settingsJson",O]]},"Get Device Settings":{methodName:"getSettings"}}},Web:{Navigation:{"Go to URL":{methodName:"navigateTo",args:[["url",O]],refresh:!0},"Get URL":{methodName:"getUrl"},Back:{methodName:"back",refresh:!0},Forward:{methodName:"forward",refresh:!0},Refresh:{methodName:"refresh",refresh:!0}}},Context:{Context:{"Get Current Context":{methodName:"getContext"},"Get Context List":{methodName:"getContexts"},"Set Context":{methodName:"switchContext",args:[["name",O]],refresh:!0}},"Window (W3C)":{"Get Window Handle":{methodName:"getWindowHandle"},"Close Window":{methodName:"closeWindow",refresh:!0},"Switch To Window":{methodName:"switchToWindow",args:[["handle",O]],refresh:!0},"Get Window Handles":{methodName:"getWindowHandles"},"New Window":{methodName:"createWindow",args:[["type",O]],refresh:!0}}}};exports.COMMAND_DEFINITIONS=u;const _={SOURCE:"source",COMMANDS:"commands",GESTURES:"gestures",SESSION_INFO:"sessionInfo"};exports.INTERACTION_MODE=_;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.UNSELECT_TICK_ELEMENT=exports.UNSELECT_HOVERED_ELEMENT=exports.UNSELECT_HOVERED_CENTROID=exports.UNSELECT_ELEMENT=exports.UNSELECT_CENTROID=exports.TOGGLE_SHOW_ATTRIBUTES=exports.TOGGLE_REFRESHING_STATE=exports.STEPS_ARRAY=exports.START_RECORDING=exports.SHOW_SIRI_COMMAND_MODAL=exports.SHOW_LOCATOR_TEST_MODAL=exports.SHOW_GESTURE_EDITOR=exports.SHOW_GESTURE_ACTION=exports.SET_VISIBLE_COMMAND_RESULT=exports.SET_USER_WAIT_TIMEOUT=exports.SET_SWIPE_START1=exports.SET_SWIPE_START=exports.SET_SWIPE_END1=exports.SET_SWIPE_END=exports.SET_SOURCE_AND_SCREENSHOT=exports.SET_SIRI_COMMAND_VALUE=exports.SET_SHOW_CENTROIDS=exports.SET_SHOW_BOILERPLATE=exports.SET_SESSION_TIME=exports.SET_SESSION_DETAILS=exports.SET_SERVER_STATUS=exports.SET_SELECTED_ELEMENT_ID=exports.SET_SEARCHED_FOR_ELEMENT_BOUNDS=exports.SET_SCREENSHOT_INTERACTION_MODE=exports.SET_LOCATOR_TEST_VALUE=exports.SET_LOCATOR_TEST_STRATEGY=exports.SET_LOCATOR_TEST_ELEMENT=exports.SET_LOADED_GESTURE=exports.SET_LAST_ACTIVE_MOMENT=exports.SET_KEEP_ALIVE_INTERVAL=exports.SET_INTERACTIONS_NOT_AVAILABLE=exports.SET_GESTURE_TAP_COORDS_MODE=exports.SET_EXPANDED_PATHS=exports.SET_CONTEXT=exports.SET_COMMAND_ARG=exports.SET_AWAITING_MJPEG_STREAM=exports.SET_APP_MODE=exports.SET_APP_ID=exports.SET_ACTION_FRAMEWORK=exports.SESSION_DONE=exports.SELECT_TICK_ELEMENT=exports.SELECT_INTERACTION_MODE=exports.SELECT_HOVERED_ELEMENT=exports.SELECT_HOVERED_CENTROID=exports.SELECT_ELEMENT=exports.SELECT_COMMAND_SUB_GROUP=exports.SELECT_COMMAND_GROUP=exports.SELECT_CENTROID=exports.SEARCHING_FOR_ELEMENTS_COMPLETED=exports.SEARCHING_FOR_ELEMENTS=exports.REMOVE_LOADED_GESTURE=exports.RECORD_ACTION=exports.QUIT_SESSION_REQUESTED=exports.QUIT_SESSION_DONE=exports.PROMPT_KEEP_ALIVE=exports.PAUSE_RECORDING=exports.METHOD_CALL_REQUESTED=exports.METHOD_CALL_DONE=exports.HIDE_SIRI_COMMAND_MODAL=exports.HIDE_PROMPT_KEEP_ALIVE=exports.HIDE_LOCATOR_TEST_MODAL=exports.HIDE_GESTURE_EDITOR=exports.HIDE_GESTURE_ACTION=exports.GET_SAVED_GESTURES_REQUESTED=exports.GET_SAVED_GESTURES_DONE=exports.GET_FIND_ELEMENTS_TIMES_COMPLETED=exports.GET_FIND_ELEMENTS_TIMES=exports.FINDING_ELEMENT_IN_SOURCE_COMPLETED=exports.FINDING_ELEMENT_IN_SOURCE=exports.ENTERING_COMMAND_ARGS=exports.DELETE_SAVED_GESTURES_REQUESTED=exports.DELETE_SAVED_GESTURES_DONE=exports.CLOSE_RECORDER=exports.CLEAR_TAP_COORDINATES=exports.CLEAR_SWIPE_ACTION=exports.CLEAR_SEARCH_RESULTS=exports.CLEAR_SEARCHED_FOR_ELEMENT_BOUNDS=exports.CLEAR_RECORDING=exports.CLEAR_ASSIGNED_VAR_CACHE=exports.CANCEL_PENDING_COMMAND=exports.ADD_ASSIGNED_VAR_CACHE=void 0,exports.addAssignedVarCache=Et,exports.applyClientMethod=st,exports.callClientMethod=oo,exports.cancelPendingCommand=Xt,exports.clearRecording=St,exports.clearSearchResults=mt,exports.clearSwipeAction=Ft,exports.closeRecorder=lt,exports.deleteSavedGesture=po,exports.displayGesture=To,exports.findAndAssign=ht,exports.getActiveAppId=wt,exports.getFindElementsTimes=ft,exports.getSavedActionFramework=it,exports.getSavedGestures=no,exports.getServerStatus=Ht,exports.hideGestureEditor=co,exports.hideKeepAlivePrompt=Bt,exports.hideLocatorTestModal=Rt,exports.hideSiriCommandModal=Nt,exports.keepSessionAlive=Zt,exports.killKeepAliveLoop=$t,exports.pauseRecording=ct,exports.promptKeepAlive=kt,exports.quitSession=pt,exports.recordAction=at,exports.removeGestureDisplay=ao,exports.removeLoadedGesture=io,exports.runKeepAliveLoop=zt,exports.saveGesture=Eo,exports.searchForElement=Lt,exports.selectAppMode=Pt,exports.selectCentroid=$e,exports.selectCommandGroup=Kt,exports.selectCommandSubGroup=Qt,exports.selectElement=Ye,exports.selectHoveredCentroid=et,exports.selectHoveredElement=ot,exports.selectInteractionMode=qt,exports.selectLocatedElement=yt,exports.selectScreenshotInteractionMode=gt,exports.selectTick=lo,exports.setActionFramework=Tt,exports.setAwaitingMjpegStream=so,exports.setCommandArg=Yt,exports.setContext=Ct,exports.setExpandedPaths=nt,exports.setLoadedGesture=So,exports.setLocatorTestElement=Mt,exports.setLocatorTestStrategy=Dt,exports.setLocatorTestValue=dt,exports.setSessionDetails=Ot,exports.setSessionTime=Vt,exports.setSiriCommandValue=xt,exports.setSwipeEnd=bt,exports.setSwipeEnd1=jt,exports.setSwipeStart=vt,exports.setSwipeStart1=Wt,exports.setVisibleCommandResult=ro,exports.showGestureEditor=_o,exports.showLocatorTestModal=At,exports.showSiriCommandModal=It,exports.startEnteringCommandArgs=Jt,exports.startRecording=_t,exports.tapTickCoordinates=Oo,exports.toggleRefreshingState=Gt,exports.toggleShowAttributes=Ao,exports.toggleShowBoilerplate=ut,exports.toggleShowCentroids=Ut,exports.unselectCentroid=Ze,exports.unselectElement=ze,exports.unselectHoveredCentroid=tt,exports.unselectHoveredElement=rt,exports.unselectTick=uo;var e=a(require("lodash")),t=require("redux-first-history"),o=require("../components/Inspector/shared"),r=require("./Session"),s=require("../util"),E=require("uuid"),n=i(require("../lib/client-frameworks")),p=require("../../shared/settings"),_=i(require("../../configs/i18next.config.renderer")),c=a(require("../lib/appium-client")),S=require("antd");function i(e){return e&&e.__esModule?e:{default:e}}function T(e){if("function"!=typeof WeakMap)return null;var t=new WeakMap,o=new WeakMap;return(T=function(e){return e?o:t})(e)}function a(e,t){if(!t&&e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var o=T(t);if(o&&o.has(e))return o.get(e);var r={},s=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var E in e)if("default"!==E&&Object.prototype.hasOwnProperty.call(e,E)){var n=s?Object.getOwnPropertyDescriptor(e,E):null;n&&(n.get||n.set)?Object.defineProperty(r,E,n):r[E]=e[E]}return r.default=e,o&&o.set(e,r),r}const l="SET_SESSION_DETAILS";exports.SET_SESSION_DETAILS=l;const u="SET_SOURCE_AND_SCREENSHOT";exports.SET_SOURCE_AND_SCREENSHOT=u;const O="SESSION_DONE";exports.SESSION_DONE=O;const A="SELECT_ELEMENT";exports.SELECT_ELEMENT=A;const R="UNSELECT_ELEMENT";exports.UNSELECT_ELEMENT=R;const I="SET_SELECTED_ELEMENT_ID";exports.SET_SELECTED_ELEMENT_ID=I;const N="SET_INTERACTIONS_NOT_AVAILABLE";exports.SET_INTERACTIONS_NOT_AVAILABLE=N;const x="METHOD_CALL_REQUESTED";exports.METHOD_CALL_REQUESTED=x;const d="METHOD_CALL_DONE";exports.METHOD_CALL_DONE=d;const D="SET_EXPANDED_PATHS";exports.SET_EXPANDED_PATHS=D;const C="SELECT_HOVERED_ELEMENT";exports.SELECT_HOVERED_ELEMENT=C;const L="UNSELECT_HOVERED_ELEMENT";exports.UNSELECT_HOVERED_ELEMENT=L;const f="SELECT_HOVERED_CENTROID";exports.SELECT_HOVERED_CENTROID=f;const h="UNSELECT_HOVERED_CENTROID";exports.UNSELECT_HOVERED_CENTROID=h;const M="SELECT_CENTROID";exports.SELECT_CENTROID=M;const y="UNSELECT_CENTROID";exports.UNSELECT_CENTROID=y;const m="SET_SHOW_CENTROIDS";exports.SET_SHOW_CENTROIDS=m;const g="QUIT_SESSION_REQUESTED";exports.QUIT_SESSION_REQUESTED=g;const G="QUIT_SESSION_DONE";exports.QUIT_SESSION_DONE=G;const P="SET_SESSION_TIME";exports.SET_SESSION_TIME=P;const U="START_RECORDING";exports.START_RECORDING=U;const w="PAUSE_RECORDING";exports.PAUSE_RECORDING=w;const H="CLEAR_RECORDING";exports.CLEAR_RECORDING=H;const V="CLOSE_RECORDER";exports.CLOSE_RECORDER=V;const v="SET_ACTION_FRAMEWORK";exports.SET_ACTION_FRAMEWORK=v;const W="RECORD_ACTION";exports.RECORD_ACTION=W;const b="STEPS_ARRAY";exports.STEPS_ARRAY=b;const j="SET_SHOW_BOILERPLATE";exports.SET_SHOW_BOILERPLATE=j;const F="SHOW_LOCATOR_TEST_MODAL";exports.SHOW_LOCATOR_TEST_MODAL=F;const k="HIDE_LOCATOR_TEST_MODAL";exports.HIDE_LOCATOR_TEST_MODAL=k;const B="SHOW_SIRI_COMMAND_MODAL";exports.SHOW_SIRI_COMMAND_MODAL=B;const K="HIDE_SIRI_COMMAND_MODAL";exports.HIDE_SIRI_COMMAND_MODAL=K;const Q="SET_SIRI_COMMAND_VALUE";exports.SET_SIRI_COMMAND_VALUE=Q;const q="SET_LOCATOR_TEST_STRATEGY";exports.SET_LOCATOR_TEST_STRATEGY=q;const J="SET_LOCATOR_TEST_VALUE";exports.SET_LOCATOR_TEST_VALUE=J;const X="SEARCHING_FOR_ELEMENTS";exports.SEARCHING_FOR_ELEMENTS=X;const Y="SEARCHING_FOR_ELEMENTS_COMPLETED";exports.SEARCHING_FOR_ELEMENTS_COMPLETED=Y;const z="GET_FIND_ELEMENTS_TIMES";exports.GET_FIND_ELEMENTS_TIMES=z;const $="GET_FIND_ELEMENTS_TIMES_COMPLETED";exports.GET_FIND_ELEMENTS_TIMES_COMPLETED=$;const Z="SET_LOCATOR_TEST_ELEMENT";exports.SET_LOCATOR_TEST_ELEMENT=Z;const ee="FINDING_ELEMENT_IN_SOURCE";exports.FINDING_ELEMENT_IN_SOURCE=ee;const te="FINDING_ELEMENT_IN_SOURCE_COMPLETED";exports.FINDING_ELEMENT_IN_SOURCE_COMPLETED=te;const oe="CLEAR_SEARCH_RESULTS";exports.CLEAR_SEARCH_RESULTS=oe;const re="ADD_ASSIGNED_VAR_CACHE";exports.ADD_ASSIGNED_VAR_CACHE=re;const se="CLEAR_ASSIGNED_VAR_CACHE";exports.CLEAR_ASSIGNED_VAR_CACHE=se;const Ee="SET_SCREENSHOT_INTERACTION_MODE";exports.SET_SCREENSHOT_INTERACTION_MODE=Ee;const ne="SET_APP_MODE";exports.SET_APP_MODE=ne;const pe="SET_SEARCHED_FOR_ELEMENT_BOUNDS";exports.SET_SEARCHED_FOR_ELEMENT_BOUNDS=pe;const _e="CLEAR_SEARCHED_FOR_ELEMENT_BOUNDS";exports.CLEAR_SEARCHED_FOR_ELEMENT_BOUNDS=_e;const ce="SET_SWIPE_START";exports.SET_SWIPE_START=ce;const Se="SET_SWIPE_END";exports.SET_SWIPE_END=Se;const ie="SET_SWIPE_START1";exports.SET_SWIPE_START1=ie;const Te="SET_SWIPE_END1";exports.SET_SWIPE_END1=Te;const ae="CLEAR_SWIPE_ACTION";exports.CLEAR_SWIPE_ACTION=ae;const le="PROMPT_KEEP_ALIVE";exports.PROMPT_KEEP_ALIVE=le;const ue="HIDE_PROMPT_KEEP_ALIVE";exports.HIDE_PROMPT_KEEP_ALIVE=ue;const Oe="SELECT_INTERACTION_MODE";exports.SELECT_INTERACTION_MODE=Oe;const Ae="SELECT_COMMAND_GROUP";exports.SELECT_COMMAND_GROUP=Ae;const Re="SELECT_COMMAND_SUB_GROUP";exports.SELECT_COMMAND_SUB_GROUP=Re;const Ie="ENTERING_COMMAND_ARGS";exports.ENTERING_COMMAND_ARGS=Ie;const Ne="CANCEL_PENDING_COMMAND";exports.CANCEL_PENDING_COMMAND=Ne;const xe="SET_COMMAND_ARG";exports.SET_COMMAND_ARG=xe;const de="SET_CONTEXT";exports.SET_CONTEXT=de;const De="SET_APP_ID";exports.SET_APP_ID=De;const Ce="SET_SERVER_STATUS";exports.SET_SERVER_STATUS=Ce;const Le="SET_KEEP_ALIVE_INTERVAL";exports.SET_KEEP_ALIVE_INTERVAL=Le;const fe="SET_USER_WAIT_TIMEOUT";exports.SET_USER_WAIT_TIMEOUT=fe;const he="SET_LAST_ACTIVE_MOMENT";exports.SET_LAST_ACTIVE_MOMENT=he;const Me="SET_VISIBLE_COMMAND_RESULT";exports.SET_VISIBLE_COMMAND_RESULT=Me;const ye="SET_AWAITING_MJPEG_STREAM";exports.SET_AWAITING_MJPEG_STREAM=ye;const me="SHOW_GESTURE_EDITOR";exports.SHOW_GESTURE_EDITOR=me;const ge="HIDE_GESTURE_EDITOR";exports.HIDE_GESTURE_EDITOR=ge;const Ge="GET_SAVED_GESTURES_REQUESTED";exports.GET_SAVED_GESTURES_REQUESTED=Ge;const Pe="GET_SAVED_GESTURES_DONE";exports.GET_SAVED_GESTURES_DONE=Pe;const Ue="DELETE_SAVED_GESTURES_REQUESTED";exports.DELETE_SAVED_GESTURES_REQUESTED=Ue;const we="DELETE_SAVED_GESTURES_DONE";exports.DELETE_SAVED_GESTURES_DONE=we;const He="SET_LOADED_GESTURE";exports.SET_LOADED_GESTURE=He;const Ve="REMOVE_LOADED_GESTURE";exports.REMOVE_LOADED_GESTURE=Ve;const ve="SHOW_GESTURE_ACTION";exports.SHOW_GESTURE_ACTION=ve;const We="HIDE_GESTURE_ACTION";exports.HIDE_GESTURE_ACTION=We;const be="SELECT_TICK_ELEMENT";exports.SELECT_TICK_ELEMENT=be;const je="UNSELECT_TICK_ELEMENT";exports.UNSELECT_TICK_ELEMENT=je;const Fe="SET_GESTURE_TAP_COORDS_MODE";exports.SET_GESTURE_TAP_COORDS_MODE=Fe;const ke="CLEAR_TAP_COORDINATES";exports.CLEAR_TAP_COORDINATES=ke;const Be="TOGGLE_SHOW_ATTRIBUTES";exports.TOGGLE_SHOW_ATTRIBUTES=Be;const Ke="TOGGLE_REFRESHING_STATE";exports.TOGGLE_REFRESHING_STATE=Ke;const Qe=2e4,qe=864e5,Je=36e5,Xe=e.default.debounce(async function(e,t,o,r){for(let[s,E]of e){const e=oo({strategy:s,selector:E});let{elementId:n,variableName:p,variableType:_}=await e(t,o);if(n&&o().inspector.selectedElementPath===r)return t({type:I,elementId:n,variableName:p,variableType:_})}return t({type:N})},1e3);function Ye(t){return async(r,s)=>{r({type:A,path:t});const{selectedElement:E,sourceXML:n,expandedPaths:p}=s().inspector,_=[...p];let c=t.split(".").slice(0,t.length-1);for(;c.length>1;){c.splice(c.length-1);let e=c.join(".");_.includes(e)||_.push(e)}r({type:D,paths:_});const S=e.default.toPairs((0,o.getLocators)(E.attributes,n));S.push(["xpath",E.xpath]),await Xe(S,r,s,t)}}function ze(){return e=>{e({type:R})}}function $e(e){return t=>{t({type:M,path:e})}}function Ze(){return e=>{e({type:y})}}function et(e){return t=>{t({type:f,path:e})}}function tt(){return e=>{e({type:h})}}function ot(e){return t=>{t({type:C,path:e})}}function rt(e){return t=>{t({type:L,path:e})}}function st(e){return async(t,o)=>{const E="quit"!==e.methodName&&"getPageSource"!==e.methodName&&"gesture"!==e.methodName&&"status"!==e.methodName&&o().inspector.isRecording;try{t({type:x});const p=oo(e),{contexts:_,contextsError:c,commandRes:S,currentContext:i,currentContextError:T,source:a,screenshot:l,windowSize:O,sourceError:A,screenshotError:R,windowSizeError:I,variableName:N,variableIndex:D,strategy:C,selector:L}=await p(t,o);if(E){if(C&&L&&!D&&0!==D){ht(C,L,N,!1)(t,o)}let r=[N,D];r=r.concat(e.args||[]),t({type:W,action:e.methodName,params:r})}return t({type:d}),a&&t({type:u,contexts:_,currentContext:i,source:a&&(0,s.xmlToJSON)(a),sourceXML:a,screenshot:l,windowSize:O,contextsError:c,currentContextError:T,sourceError:A,screenshotError:R,windowSizeError:I}),window.dispatchEvent(new Event("resize")),S}catch(n){console.log(n);let o="click"===e.methodName?"tap":e.methodName;(0,r.showError)(n,o,10),t({type:d})}}}function Et(e){return t=>{t({type:re,varName:e})}}function nt(e){return t=>{t({type:D,paths:e})}}function pt(e,o=!0){return async(r,s)=>{$t()(r,s);const E=st({methodName:"quit"});await E(r,s),r({type:G}),r((0,t.push)("/session")),o||S.notification.error({message:"Error",description:e||_.default.t("Session has been terminated"),duration:0})}}function _t(){return e=>{e({type:U})}}function ct(){return e=>{e({type:w})}}function St(){return e=>{e({type:H}),e({type:se})}}function it(){return async e=>{let t=await(0,p.getSetting)(p.SAVED_FRAMEWORK);e({type:v,framework:t})}}function Tt(e){return async t=>{if(!n.default[e])throw new Error(_.default.t("frameworkNotSupported",{framework:e}));await(0,p.setSetting)(p.SAVED_FRAMEWORK,e),t({type:v,framework:e})}}function at(e,t){return o=>{o({type:W,action:e,params:t})}}function lt(){return e=>{e({type:V})}}function ut(){return(e,t)=>{const o=!t().inspector.showBoilerplate;e({type:j,show:o})}}function Ot({driver:e,sessionDetails:t,mode:o,mjpegScreenshotUrl:r}){return s=>{s({type:l,driver:e,sessionDetails:t,mode:o,mjpegScreenshotUrl:r})}}function At(){return e=>{e({type:F})}}function Rt(){return e=>{e({type:k})}}function It(){return e=>{e({type:B})}}function Nt(){return e=>{e({type:K})}}function xt(e){return t=>{t({type:Q,siriCommandValue:e})}}function dt(e){return t=>{t({type:J,locatorTestValue:e})}}function Dt(e){return t=>{t({type:q,locatorTestStrategy:e})}}function Ct(e){return t=>{t({type:de,context:e})}}function Lt(e,t){return async(o,s)=>{o({type:X});try{const n=oo({strategy:e,selector:t,fetchArray:!0});let{elements:p,variableName:_,executionTime:c}=await n(o,s);ht(e,t,_,!0)(o,s),p=p.map(e=>e.id),o({type:Y,elements:p,executionTime:c})}catch(E){o({type:Y}),(0,r.showError)(E,10)}}}function ft(t){return async(o,s)=>{o({type:z});try{const n=[];for(const e of t){const{find:t,key:r,selector:E}=e,p=oo({strategy:r,selector:E}),{executionTime:_}=await p(o,s);n.push({find:t,key:r,selector:E,time:_})}o({type:$,findElementsExecutionTimes:e.default.sortBy(n,["time"])})}catch(E){o({type:$}),(0,r.showError)(E,10)}}}function ht(e,t,o,r){return(s,E)=>{const{assignedVarCache:n}=E().inspector;n[o]||(s({type:W,action:"findAndAssign",params:[e,t,o,r]}),s({type:re,varName:o}))}}function Mt(e){return async(t,o)=>{if(t({type:Z,elementId:e}),t({type:_e}),e)try{const s=oo({elementId:e,methodName:"getRect",skipRefresh:!0,skipRecord:!0,ignoreResult:!0}),{commandRes:E}=await s(t,o);t({type:pe,location:{x:E.x,y:E.y},size:{width:E.width,height:E.height}})}catch(r){}}}function yt(e,t,o){const r=10;function s(){if(!t||!e.children||!e.children[0].attributes)return null;if(e.children[0].attributes.bounds){const[o,r]=[t.location.x+t.size.width,t.location.y+t.size.height],s=`[${t.location.x},${t.location.y}][${o},${r}]`;return function e(t,o){let r=[];for(const s of t)s.attributes.bounds===o&&r.push([s.path,s.xpath]),s.children.length&&r.push(...e(s.children,o));return r}(e.children,s)}if(e.children[0].attributes.x){const o={x:String(t.location.x),y:String(t.location.y),height:String(t.size.height),width:String(t.size.width)};return function e(t,o){let r=[];for(const s of t)s.attributes.x===o.x&&s.attributes.y===o.y&&s.attributes.height===o.height&&s.attributes.width===o.width&&r.push([s.path,s.xpath]),s.children.length&&r.push(...e(s.children,o));return r}(e.children,o)}return null}async function E(e,t,s){return e?1===e.length?e[0][0]:0!==e.length&&e.length<=r?await async function(e,t,r){for(const s of e){const e=oo({strategy:"xpath",selector:s[1]}),{el:E}=await e(t,r);if(E&&E.elementId===o)return s[0]}return null}(e,t,s):null:null}return async(e,t)=>{e({type:ee});const o=s(),r=await E(o,e,t);if(r){const o=Ye(r);await o(e,t)}else S.notification.error({message:_.default.t("Error"),description:_.default.t("findingElementInSourceFailed"),duration:8});e({type:te})}}function mt(){return e=>{e({type:oe}),e({type:_e})}}function gt(e){return t=>{t({type:Ee,screenshotInteractionMode:e})}}function Gt(){return e=>{e({type:Ke})}}function Pt(e){return async(t,r)=>{const{appMode:s}=r().inspector;if(t({type:ne,mode:e}),s!==e&&e===o.APP_MODE.WEB_HYBRID){const e=st({methodName:"getPageSource"});await e(t,r)}if(s!==e&&e===o.APP_MODE.NATIVE){const e=st({methodName:"switchContext",args:[c.NATIVE_APP]});await e(t,r)}}}function Ut(){return(e,t)=>{const{showCentroids:o}=t().inspector;e({type:m,show:!o})}}function wt(e,t){return async(o,r)=>{try{if(e){const e=st({methodName:"executeScript",args:["mobile:activeAppInfo",[]]}),{bundleId:t}=await e(o,r);o({type:De,appId:t})}if(t){const e=st({methodName:"getCurrentPackage"}),t=await e(o,r);o({type:De,appId:t})}}catch(s){console.error(`Could not Retrieve Active App ID: ${s}`)}}}function Ht(){return async(e,t)=>{const o=st({methodName:"status"}),{build:r}=await o(e,t);e({type:Ce,status:r})}}function Vt(e){return t=>{t({type:P,sessionStartTime:e})}}function vt(e,t){return o=>{o({type:ce,swipeStartX:e,swipeStartY:t})}}function Wt(e,t){return o=>{o({type:ie,swipeStartX:e,swipeStartY:t})}}function bt(e,t){return o=>{o({type:Se,swipeEndX:e,swipeEndY:t})}}function jt(e,t){return o=>{o({type:Te,swipeEndX:e,swipeEndY:t})}}function Ft(){return e=>{e({type:ae})}}function kt(){return e=>{e({type:le})}}function Bt(){return e=>{e({type:ue})}}function Kt(e){return t=>{t({type:Ae,group:e})}}function Qt(e){return t=>{t({type:Re,group:e})}}function qt(e){return t=>{t({type:Oe,interaction:e})}}function Jt(e,t){return o=>{o({type:Ie,commandName:e,command:t})}}function Xt(){return e=>{e({type:Ne})}}function Yt(e,t){return o=>{o({type:xe,index:e,value:t})}}function zt(){return(e,t)=>{e({type:he,lastActiveMoment:Date.now()});const{driver:o}=t().inspector,r=setInterval(async()=>{const{lastActiveMoment:r}=t().inspector;console.log("Pinging Appium server to keep session active");try{await o.getTimeouts()}catch(s){}if(Date.now()-r>qe){kt()(e);const o=setTimeout(()=>{pt(_.default.t("Session closed due to inactivity"),!1)(e,t)},Je);e({type:fe,userWaitTimeout:o})}},Qe);e({type:Le,keepAliveInterval:r})}}function $t(){return(e,t)=>{const{keepAliveInterval:o,userWaitTimeout:r}=t().inspector;clearInterval(o),r&&clearTimeout(r),e({type:Le,keepAliveInterval:null}),e({type:fe,userWaitTimeout:null})}}function Zt(){return(e,t)=>{const{userWaitTimeout:o}=t().inspector;Bt()(e),e({type:he,lastActiveMoment:+new Date}),o&&(clearTimeout(o),e({type:fe,userWaitTimeout:null}))}}const eo=e=>fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});let to=[];function oo(t){return async(o,r)=>{console.log("🚀 ~ file: Inspector.js:803 ~ return ~ params:",t),console.log("🚀 ~ file: Inspector.js:804 ~ return ~ getState",r());const{driver:s,appMode:E,mjpegScreenshotUrl:n,isSourceRefreshOn:p,selectedElement:_,screenshotInteractionMode:S}=r().inspector;console.log("🚀 ~ file: Inspector.js:811 ~ return ~ selectedElement:",_);const{methodName:i,ignoreResult:T=!0}=t;t.appMode=E,n&&(t.skipScreenshot=!0),p||(t.skipRefresh=!0),console.log("Calling client method with params:",t),Zt()(o,r),console.log("driver session id",s.sessionId);const a=c.default.instance(s),l=await a.run(t);let{commandRes:u}=l,O={session_id:s.sessionId,params:t,selectedElement:_,"step-name":S},A={session_id:s.sessionId,"step-name":"steps"};if(console.log("🚀 ~ file: Inspector.js:825 ~ return ~ postdata:",O),"click"===O.params.methodName)console.log("🚀 ~ file: Inspector.js:825 ~ return ~ postdata:",O),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(O)}).then(e=>{console.log("API response:",e),O.response=e,to.push(O),o({type:b,data:to})}).catch(e=>{console.error("API error:",e)}),eo(A).then(e=>{console.log("🚀 ~ file: Inspector.js:886 ~ fetchSteps ~ res:",e);let t=e.steps;o({type:b,data:t})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:890 ~ fetchSteps ~ error:",e)});else if("swipe"===O.params.methodName)delete O.selectedElement,console.log("🚀 ~ file: Inspector.js:825 ~ return ~ postdata:",O),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(O)}).then(e=>{console.log("API response:",e),O.response=e,console.log("🚀 ~ file: Inspector.js:882 ~ .then ~ data:",to)}).catch(e=>{console.error("API error:",e)}),eo(A).then(e=>{console.log("🚀 ~ file: Inspector.js:886 ~ fetchSteps ~ res:",e);let t=e.steps;o({type:b,data:t})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:890 ~ fetchSteps ~ error:",e)});else if("tap"===O.params.methodName)console.log("🚀 ~ file: Inspector.js:825 ~ return ~ postdata:",O),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(O)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)}),eo(A).then(e=>{console.log("🚀 ~ file: Inspector.js:886 ~ fetchSteps ~ res:",e);let t=e.steps;o({type:b,data:t})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:890 ~ fetchSteps ~ error:",e)});else if("sendKeys"===O.params.methodName)console.log("🚀 ~ file: Inspector.js:825 ~ return ~ postdata:",O),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(O)}).then(e=>{console.log("API response:",e),O.response=e,to.push(O)}).catch(e=>{console.error("API error:",e)}),eo(A).then(e=>{console.log("🚀 ~ file: Inspector.js:886 ~ fetchSteps ~ res:",e);let t=e.steps;o({type:b,data:t})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:890 ~ fetchSteps ~ error:",e)});else if("expected_value"===O["step-name"])O.params.xpath=O.selectedElement.xpath,O.params.expected_value=O.selectedElement.attributes.text,console.log("🚀 ~ file: Inspector.js:916 ~ return ~ postdata:",O),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(O)}).then(e=>{console.log("API response for expected_value:",e),O.response=e,to.push(O)}).catch(e=>{console.error("API error:",e)}),eo(A).then(e=>{console.log("🚀 ~ file: Inspector.js:886 ~ fetchSteps ~ res:",e);let t=e.steps;o({type:b,data:t})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:890 ~ fetchSteps ~ error:",e)});else if("quit"===t.methodName){console.log("🚀 inside the quit function!!");let e={session_id:s.sessionId,"step-name":"quit"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)}),eo(A).then(e=>{console.log("🚀 ~ file: Inspector.js:886 ~ fetchSteps ~ res:",e);let t=e.steps;o({type:b,data:t})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:890 ~ fetchSteps ~ error:",e)})}else console.log("no api will call becopuse of the no action happend@@@@@@@@@@@");if(e.default.isObject(l)&&e.default.isEmpty(l)&&(u=null),!T){const t=JSON.stringify(u,null,"  "),r=e.default.truncate(t,{length:2e3});console.log(`Got result from client method: ${r}`),ro(t,i)(o)}return l.elementId=l.id,l}}function ro(e,t){return o=>{o({type:Me,result:e,methodName:t})}}function so(e){return t=>{t({type:ye,isAwaiting:e})}}function Eo(e){return async t=>{let o=await(0,p.getSetting)(p.SET_SAVED_GESTURES)||[];if(e.id)for(const s of o)s.id===e.id&&(s.name=e.name,s.description=e.description,s.actions=e.actions);else e.id=(0,E.v4)(),e.date=Date.now(),o.push(e);await(0,p.setSetting)(p.SET_SAVED_GESTURES,o);const r=no();await r(t)}}function no(){return async e=>{e({type:Ge});const t=await(0,p.getSetting)(p.SET_SAVED_GESTURES);e({type:Pe,savedGestures:t})}}function po(e){return async t=>{t({type:Ue,deleteGesture:e});const o=(await(0,p.getSetting)(p.SET_SAVED_GESTURES)).filter(t=>t.id!==e);await(0,p.setSetting)(p.SET_SAVED_GESTURES,o),t({type:we}),t({type:Pe,savedGestures:o})}}function _o(){return e=>{e({type:me}),e({type:Ee,screenshotInteractionMode:"gesture"})}}function co(){return e=>{e({type:ge}),e({type:Ee,screenshotInteractionMode:"select"})}}function So(e){return t=>{t({type:He,loadedGesture:e})}}function io(){return e=>{e({type:Ve})}}function To(e){return t=>{t({type:ve,showGesture:e})}}function ao(){return e=>{e({type:We})}}function lo(e){return(t,o)=>{const{tickCoordinates:r}=o().inspector;r&&t({type:Fe,x:void 0,y:void 0}),t({type:be,selectedTick:e})}}function uo(){return e=>{e({type:ke}),e({type:je})}}function Oo(e,t){return o=>{o({type:Fe,x:e,y:t})}}function Ao(){return e=>{e({type:Be})}}
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=u(require("react")),t=i(require("./HighlighterRects")),a=require("antd"),n=i(require("bluebird")),o=i(require("./Inspector.css")),l=require("./shared"),r=require("react-icons/io5"),s=require("react-icons/bi");function i(e){return e&&e.__esModule?e:{default:e}}function c(e){if("function"!=typeof WeakMap)return null;var t=new WeakMap,a=new WeakMap;return(c=function(e){return e?a:t})(e)}function u(e,t){if(!t&&e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var a=c(t);if(a&&a.has(e))return a.get(e);var n={},o=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var l in e)if("default"!==l&&Object.prototype.hasOwnProperty.call(e,l)){var r=o?Object.getOwnPropertyDescriptor(e,l):null;r&&(r.get||r.set)?Object.defineProperty(n,l,r):n[l]=e[l]}return n.default=e,a&&a.set(e,n),n}function d(){return(d=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e}).apply(this,arguments)}const{POINTER_UP:y,POINTER_DOWN:p,PAUSE:E,POINTER_MOVE:f}=l.POINTER_TYPES,{TAP:m,SELECT:N,SLIDE:x,SWIPE:T,LONGPRESS:O,DRAG_AND_DROP:S,DOUBLE_TAP:h,SLIDE_SWIPE:g,ZOOMIN:_,SELECT_LONG:I,SELECT_DOUBLE:A,FILE_UPLOAD:D,SELECT_FILE:w,EXPECTED_VALUE:R,TAKE_SCREENSHOT:b,SCRATCH:P}=l.SCREENSHOT_INTERACTION_MODE,v={FILLED:"filled",NEW_DASHED:"newDashed",WHOLE:"whole",DASHED:"dashed",DRAG:"drag"},U=i=>{const{screenshot:c,mjpegScreenshotUrl:u,methodCallInProgress:U,driver:M,selectScreenshotInteractionMode:L,screenshotInteractionMode:C,step_object:B,swipeStart:k,swipeEnd1:j,swipeStart1:G,swipeEnd:F,scaleRatio:H,selectedTick:W,selectedInteractionMode:$,applyClientMethod:q,t:K,hoveredElement:V}=i,[X,Y]=(0,e.useState)(null),[Z,z]=(0,e.useState)(null),[J,Q]=(0,e.useState)({}),[ee,te]=(0,e.useState)([]),[ae,ne]=(0,e.useState)(!1);(0,e.useEffect)(()=>{if(V&&V.attributes&&V.attributes.bounds){const e=V.attributes.bounds;console.log("coordinatestring",e);const t=e.match(/\d+/g);if(t.length>=4){parseInt(t[0],10),parseInt(t[1],10);const e=parseInt(t[2],10),a=parseInt(t[3],10),n=Math.round(e),o=Math.round(a);Y(n),z(o)}}},[V]);const oe=(0,e.useRef)(),[le,re]=(0,e.useState)(),[se,ie]=(0,e.useState)(),[ce,ue]=(0,e.useState)(!1),[de,ye]=(0,e.useState)({});let[pe,Ee]=(0,e.useState)({x:0,y:0,scale:1});oe.current,(0,e.useRef)();const fe=()=>{console.log("inside the use file upload function!!!!!!");const{POINTER_NAME:e,DURATION_1:t,DURATION_2:a,BUTTON:n}=l.DEFAULT_TAP,{clearSwipeAction:o}=i;q({methodName:m,args:[{[e]:[{type:f,duration:t,x:le,y:se},{type:p,button:n},{type:E,duration:a},{type:y,button:n}]}]}),o(),L(D)},me=async()=>{const{LONGPRESS_POINTER_NAME:e,LONGPRESS_DURATION_1:t,LONGPRESS_DURATION_2:a,LONGPRESS_BUTTON:n}=l.DEFAULT_LONGPRESS;let o={methodName:m,args:{[e]:[{type:f,duration:t,x:le,y:se},{type:p,button:n},{type:E,duration:a},{type:y,button:n}]}};await q(o),L(O)},Ne=()=>{const{POINTER_NAME:e,DURATION_1:t,DURATION_2:a,BUTTON:n}=l.DEFAULT_TAP;q({methodName:m,args:[{[e]:[{type:f,duration:t,x:le,y:se},{type:p,button:n},{type:E,duration:a},{type:y,button:n}]}]});setTimeout(()=>{q({methodName:m,args:[{[e]:[{type:f,duration:t,x:le,y:se},{type:p,button:n},{type:E,duration:a},{type:y,button:n}]}]})},50),L(h)},xe=async e=>{console.log("🚀 ~ file: Screenshot.js:293 ~ scratchCard ~ e:",e),console.log("scratching"),!0===ae&&await _e(e)},Te=async e=>{const{clearSwipeAction:t}=i,{POINTER_NAME:a,DURATION_1:n,DURATION_2:o,BUTTON:r,ORIGIN:s}=l.DEFAULT_SWIPE;await q({methodName:T,args:{[a]:[{type:f,duration:n,x:k.x,y:k.y},{type:p,button:r},{type:f,duration:o,origin:s,x:e.x,y:e.y},{type:y,button:r}]}}),t(),B&&console.log("🚀 ~ file: Screenshot.js:97 ~ Screenshot ~ step_object:",B)},Oe=async e=>{console.log("🚀 ~ file: Screenshot.js:332 ~ handleDoSwipeSlide ~ props:",i);let t=i.selectedElement.xpath;console.log("🚀 ~ file: Screenshot.js:304 ~ handleDoSwipeSlide ~ xpath:",t);const{clearSwipeAction:a}=i,{POINTER_NAME:n,DURATION_1:o,DURATION_2:r,BUTTON:s,ORIGIN:c}=l.DEFAULT_SWIPE;let u={methodName:T,args:{[n]:[{type:f,duration:o,x:k.x,y:k.y},{type:p,button:s},{type:f,duration:r,origin:c,x:e.x,y:e.y},{type:y,button:s}]}};t&&(u.xpath=t),await q(u),L(x),a()},Se=async e=>{const{clearSwipeAction:t}=i,{POINTER_NAME:a,DURATION_1:n,DURATION_2:o,BUTTON:r,ORIGIN:s}=l.DEFAULT_DRAG_AND_DROP;await q({methodName:m,args:{[a]:[{type:f,duration:n,origin:s,x:k.x,y:k.y},{type:p,button:r},{type:E,duration:o},{type:f,duration:o,origin:s,x:e.x,y:e.y},{type:y,button:r}]}}),t()},he=async(e,t)=>{const{clearSwipeAction:a}=i,{POINTER_NAME1:n,POINTER_NAME2:o,DURATION_1:r,DURATION_2:s,BUTTON:c,ORIGIN:u}=l.DEFAULT_ZOOM;console.log(`swipeStart.x : ${k.x}, swipeStart.y : : ${k.y} , swipeEndLocal1.x : ${t.x} , swipeEndLocal1.y : ${t.y} , swipeStart1.x : ${G.x} , swipeStart1.y : ${G.y}, swipeEndLocal.x : ${e.x} , swipeEndLocal.y : ${e.y}`),e&&t&&(await q({methodName:T,args:{[n]:[{type:f,duration:r,x:k.x,y:k.y},{type:p,button:c},{type:f,duration:s,origin:u,x:t.x,y:t.y},{type:y,button:c}],[o]:[{type:f,duration:r,x:G.x,y:G.y},{type:p,button:c},{type:f,duration:s,origin:u,x:e.x,y:e.y},{type:y,button:c}]}}),a())},ge=async e=>{const{POINTER_NAME:t,DURATION_1:a,DURATION_2:n,BUTTON:o,ORIGIN:r}=l.DEFAULT_SWIPE;let s={methodName:m,args:{[t]:[{type:f,duration:a,origin:r,x:k.x,y:k.y},{type:p,button:o},{type:E,duration:n}]},xpath:e.xpath,expected_value:e.expected_value};await q(s)},_e=e=>{const{clearSwipeAction:t}=i,{POINTER_NAME1:a,POINTER_NAME2:n,DURATION_1:o,DURATION_2:r,BUTTON:s,ORIGIN:c}=l.DEFAULT_ZOOM;if(C!==N){const l=e.nativeEvent.offsetX,i=e.nativeEvent.offsetY,u=l*H,d=i*H;re(Math.round(u)),ie(Math.round(d)),C===P&&(te(e=>[...e,{x:Math.round(u),y:Math.round(d)}]),ee.length>250&&(console.log("🚀 ~ file: Screenshot.js:440 ~ handleMouseMove ~ coordinates.length:",ee),q({methodName:T,args:{[a]:[{type:f,duration:o,x:ee[0].x,y:ee[0].y},{type:p,button:s},{type:f,duration:r,origin:c,x:ee[80].x,y:ee[80].y},{type:y,button:s}],[n]:[{type:f,duration:o,x:ee[80].x,y:ee[80].y},{type:p,button:s},{type:f,duration:r,origin:c,x:ee[160].x,y:ee[160].y},{type:y,button:s}]}}),t(),te([]),ne(!1)))}console.log("🚀 ~ file: Screenshot.js:406 ~ handleMouseMove ~ e:",e)},Ie={};[m,T].includes(C)||W?Ie.cursor="crosshair":[S].includes(C)||W?Ie.cursor="move":Ie.cursor="pointer",([_,g].includes(C)||W)&&(Ie.cursor="crosshair");let Ae=null;C!==T||k&&F||(k?F||(Ae=K("Click swipe end point")):Ae=K("Click swipe start point"));const De=u||`data:image/gif;base64,${c}`,we=e.default.createElement("img",{src:De,id:"screenshot",className:o.default.screenimage}),Re=(()=>{const{showGesture:e}=i,{FILLED:t,NEW_DASHED:a,WHOLE:n,DASHED:o}=v,l={pointerDown:n,pointerUp:o};return e?e.map(e=>{let r=o;const s=[];for(const i of e.ticks){if(i.type===E)continue;const c=s.length;r=i.type!==f?l[i.type]:r,i.type===f&&void 0!==i.x&&void 0!==i.y&&s.push({id:i.id,type:r,x:i.x,y:i.y,color:e.color}),0===c?i.type===p&&s.push({id:i.id,type:t,x:0,y:0,color:e.color}):(i.type===p&&s[c-1].type===o&&(s[c-1].type=t),i.type===y&&s[c-1].type===n&&(s[c-1].type=a))}return s}):null})();return e.default.createElement(a.Spin,{size:"large",spinning:!!U&&!u},e.default.createElement("div",{className:o.default.innerScreenshotContainer},e.default.createElement("div",{ref:oe,style:Ie,onMouseDown:async e=>{const{setSwipeStart:t,setSwipeEnd:a,tapTickCoordinates:o,setSwipeStart1:r,setSwipeEnd1:s}=i,{POINTER_NAME:c,DURATION_1:u,DURATION_2:d,BUTTON:N}=l.DEFAULT_TAP;if(C===m)q({methodName:m,args:[{[c]:[{type:f,duration:u,x:le,y:se},{type:p,button:N},{type:E,duration:d},{type:y,button:N}]}]});else if(C===O)console.log("inside the condition of the longpress!!"),setTimeout(()=>{L(I)},2e3);else if(C===I)await me();else if(C===h)console.log("inside the double tap function!!!"),setTimeout(()=>{L(A)},1e3);else if(C===A)await Ne();else if(C===S)console.log("inside the drage and drop condition value!!!!!!"),k?F||(a(le,se),Se({x:le,y:se})):t(le,se);else if(W)o(le,se);else if(C===T)k?F||(a(le,se),await n.default.delay(500),await Te({x:le,y:se})):t(le,se);else if(C===_)k?F?G?j||(s(le,se),await n.default.delay(500),await he({x:le,y:se},de)):r(le,se):(a(le,se),await n.default.delay(500),ye({x:le,y:se})):t(le,se);else if(C===x)setTimeout(()=>{L(g)},1e3),i.selectedElement&&Q(i.selectedElement);else if(C===g)k?F||(a(le,se),await n.default.delay(500),await Oe({x:le,y:se})):t(le,se);else if(C===D)console.log("inside the file upload condition!!!!!!!!!"),setTimeout(()=>{L(w)},1e3);else if(C===w)console.log("inside the select file condition!!!!!!!!!"),await fe();else if(C===R){let e="",t={};i.selectedElement&&(t={expected_value:e=i.selectedElement.attributes.text,xpath:i.selectedElement.xpath}),await ge(t)}else C===b?await M.client.takeScreenshot():C===P&&(console.log("🚀 ~ file: Screenshot.js:201 ~ handleScreenshotClick ~ e:",e),k||(ne(!0),te([]),await xe(e),t(le,se)))},onMouseMove:_e,onMouseOut:()=>{re(null),ie(null)},onDragOver:e=>{e.preventDefault()},onDrop:e=>{const{offsetX:t,offsetY:a}=e.nativeEvent,n=t*H,o=a*H,l=Math.round(n),r=Math.round(o);console.log("Drop position:",{x:l,y:r}),re(l),ie(r),te([]),ne(!1),setTimeout(async()=>{await Se({x:l,y:r})},1e3)},className:o.default.screenshotBox},C!==N&&e.default.createElement("div",{className:o.default.coordinatesContainer},e.default.createElement("p",null,K("xCoordinate",{x:le})),e.default.createElement("p",null,K("yCoordinate",{y:se}))),Ae&&e.default.createElement(a.Tooltip,{open:!0,title:Ae,placement:"topLeft"},we),!Ae&&we,C===N&&oe.current&&e.default.createElement(t.default,d({},i,{containerEl:oe.current})),C===x&&oe.current&&e.default.createElement(t.default,d({},i,{containerEl:oe.current})),C===h&&oe.current&&e.default.createElement(t.default,d({},i,{containerEl:oe.current})),C===O&&oe.current&&e.default.createElement(t.default,d({},i,{containerEl:oe.current})),C===R&&oe.current&&e.default.createElement(t.default,d({},i,{containerEl:oe.current})),C===D&&oe.current&&e.default.createElement(t.default,d({},i,{containerEl:oe.current})),C===T&&e.default.createElement("svg",{className:o.default.swipeSvg},k&&!F&&e.default.createElement("circle",{cx:k.x/H,cy:k.y/H}),k&&F&&e.default.createElement("line",{x1:k.x/H,y1:k.y/H,x2:F.x/H,y2:F.y/H})),C===P&&e.default.createElement("svg",{className:o.default.swipeSvg},k&&ae&&ee.map((t,a)=>e.default.createElement("circle",{key:a,cx:t.x/H,cy:t.y/H}))),C===g&&e.default.createElement("svg",{className:o.default.swipeSvg},k&&!F&&e.default.createElement("circle",{cx:k.x/H,cy:k.y/H}),k&&F&&e.default.createElement("line",{x1:k.x/H,y1:k.y/H,x2:F.x/H,y2:F.y/H})),C===S&&e.default.createElement("svg",{className:o.default.swipeSvg},k&&!F&&e.default.createElement("circle",{cx:k.x/H,cy:k.y/H}),k&&F&&e.default.createElement("line",{x1:k.x/H,y1:k.y/H,x2:F.x/H,y2:F.y/H})),C===_&&e.default.createElement("svg",{className:o.default.swipeSvg},k&&!F&&e.default.createElement("circle",{cx:k.x/H,cy:k.y/H}),k&&F&&e.default.createElement("line",{x1:k.x/H,y1:k.y/H,x2:F.x/H,y2:F.y/H}),G&&!j&&e.default.createElement("circle",{cx:G.x/H,cy:G.y/H}),G&&j&&e.default.createElement("line",{x1:G.x/H,y1:G.y/H,x2:j.x/H,y2:j.y/H})),C===m&&e.default.createElement("div",{className:o.default.tapDiv}),$===l.INTERACTION_MODE.GESTURES&&Re&&e.default.createElement("svg",{key:"gestureSVG",className:o.default.gestureSvg},Re.map(t=>t.map((a,n)=>e.default.createElement(e.default.Fragment,{key:a.id},n>0&&e.default.createElement("line",{className:o.default[a.type],key:`${a.id}.line`,x1:t[n-1].x/H,y1:t[n-1].y/H,x2:a.x/H,y2:a.y/H,style:{stroke:a.color}}),e.default.createElement("circle",{className:o.default[`circle-${a.type}`],key:`${a.id}.circle`,cx:a.x/H,cy:a.y/H,style:a.type===v.FILLED?{fill:a.color}:{stroke:a.color}}))))))),M&&M.client.isAndroid&&e.default.createElement("div",{className:o.default["whole-btn"]},e.default.createElement(a.Tooltip,{title:K("Press Back Button")},e.default.createElement(a.Button,{id:"btnPressHomeButton",className:o.default["phone-btn1"],icon:e.default.createElement(r.IoChevronBackOutline,{className:o.default["custom-button-icon"]}),onClick:()=>q({methodName:"pressKeyCode",args:[4]})})),e.default.createElement(a.Tooltip,{title:K("Press Home Button")},e.default.createElement(a.Button,{id:"btnPressHomeButton",className:o.default["phone-btn2"],icon:e.default.createElement(s.BiCircle,{className:o.default["custom-button-icon"]}),onClick:()=>q({methodName:"pressKeyCode",args:[3]})})),e.default.createElement(a.Tooltip,{title:K("Press App Switch Button")},e.default.createElement(a.Button,{id:"btnPressHomeButton",className:o.default["phone-btn3"],icon:e.default.createElement(s.BiSquare,{className:o.default["custom-button-icon"]}),onClick:()=>q({methodName:"pressKeyCode",args:[187]})}))))};var M=U;exports.default=M;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=T(require("react")),t=require("lodash"),n=require("./shared"),l=require("antd"),a=I(require("./Screenshot")),s=I(require("./HeaderButtons")),i=I(require("./SelectedElement")),r=I(require("./Source")),o=I(require("./Inspector.css")),c=I(require("./RecordedActions")),d=I(require("./Commands")),u=I(require("./SavedGestures")),h=I(require("./GestureEditor")),m=I(require("./SessionInfo")),p=require("../../polyfills"),f=require("@ant-design/icons"),E=require("../AntdTypes");function I(e){return e&&e.__esModule?e:{default:e}}function O(e){if("function"!=typeof WeakMap)return null;var t=new WeakMap,n=new WeakMap;return(O=function(e){return e?n:t})(e)}function T(e,t){if(!t&&e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var n=O(t);if(n&&n.has(e))return n.get(e);var l={},a=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var s in e)if("default"!==s&&Object.prototype.hasOwnProperty.call(e,s)){var i=a?Object.getOwnPropertyDescriptor(e,s):null;i&&(i.get||i.set)?Object.defineProperty(l,s,i):l[s]=e[s]}return l.default=e,n&&n.set(e,l),l}function S(){return(S=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var l in n)Object.prototype.hasOwnProperty.call(n,l)&&(e[l]=n[l])}return e}).apply(this,arguments)}const{SELECT:v,SWIPE:C,TAP:A,LONGPRESS:g,DRAG_AND_DROP:N,DOUBLE_TAP:M,ZOOMIN:x,SLIDE:R,FILE_UPLOAD:y,EXPECTED_VALUE:b,TAKE_SCREENSHOT:B,SCRATCH:w}=n.SCREENSHOT_INTERACTION_MODE,U=l.Button.Group,k=870,P=610,_=500,D=1e3;function j(e){let t=document.createElement("a");t.setAttribute("href","data:application/xml;charset=utf-8,"+encodeURIComponent(e)),t.setAttribute("download","source.xml"),t.style.display="none",document.body.appendChild(t),t.click(),document.body.removeChild(t)}class L extends e.Component{constructor(){super(),this.didInitialResize=!1,this.state={scaleRatio:1,activeIndex:0,showPanel:!1},this.screenAndSourceEl=null,this.lastScreenshot=null,this.screenshotEl=null,this.updateSourceTreeWidth=(0,t.debounce)(this.updateSourceTreeWidth.bind(this),50),this.updateScaleRatio=(0,t.debounce)(this.updateScaleRatio.bind(this),500),this.mjpegStreamCheckInterval=null}updateScaleRatio(){const e=this.screenshotEl.querySelector("img");this.setState({scaleRatio:this.props.windowSize.width/e.offsetWidth})}updateSourceTreeWidth(){if(!this.screenAndSourceEl)return;const e=this.screenAndSourceEl.querySelector("#screenshotContainer"),t=this.screenAndSourceEl.querySelector("#screenshotContainer img#screenshot");if(!t)return;const n=t.getBoundingClientRect(),l=e.getBoundingClientRect();if(e.style.flexBasis=`${n.width}px`,n.height<l.height){const t=l.height/n.height*n.width;e.style.maxWidth=t>_?`${_}px`:`${t}px`}else n.width<l.width&&(e.style.maxWidth=`${n.width}px`);this.updateScaleRatio()}componentDidMount(){const e=window.innerHeight,t=window.innerWidth,n=e<P||t<k;if(!this.didInitialResize&&n){const n=t<k?k:t,l=e<P?P:e;window.resizeTo(n,l)}this.didInitialResize=!0,console.log("props in the inspector",this.props),this.props.applyClientMethod({methodName:"getPageSource",ignoreResult:!0}),this.props.getSavedActionFramework(),this.props.runKeepAliveLoop(),window.addEventListener("resize",this.updateSourceTreeWidth),this.props.setSessionTime(Date.now()),this.props.mjpegScreenshotUrl&&(this.mjpegStreamCheckInterval=setInterval(this.checkMjpegStream.bind(this),D))}async checkMjpegStream(){const{mjpegScreenshotUrl:e,isAwaitingMjpegStream:t,setAwaitingMjpegStream:n}=this.props,l=new Image;l.src=e;let a=!1;try{await l.decode(),a=!0}catch(s){}a&&t?(n(!1),this.updateSourceTreeWidth()):a||t||n(!0)}componentDidUpdate(){const{screenshot:e}=this.props;e!==this.lastScreenshot&&(this.updateSourceTreeWidth(),this.lastScreenshot=e)}componentWillUnmount(){this.mjpegStreamCheckInterval&&(clearInterval(this.mjpegStreamCheckInterval),this.mjpegStreamCheckInterval=null)}handlePanel(e){this.setState({showPanel:!this.state.showPanel})}screenshotInteractionChange(e){const{selectScreenshotInteractionMode:t,clearSwipeAction:n}=this.props;n(),t(e)}setActiveIndex(e){this.setState({activeIndex:e})}render(){const{screenshot:t,screenshotError:r,selectedElement:p={},quitSession:I,showRecord:O,screenshotInteractionMode:T,visibleCommandMethod:k,selectedInteractionMode:P,selectInteractionMode:_,setVisibleCommandResult:D,showKeepAlivePrompt:j,keepSessionAlive:L,sourceXML:q,t:F,visibleCommandResult:W,mjpegScreenshotUrl:Y,isAwaitingMjpegStream:G,toggleShowCentroids:H,showCentroids:z,isGestureEditorVisible:$,toggleShowAttributes:K,isSourceRefreshOn:V}=this.props,{path:X}=p,{driver:Z}=this.props;console.log("driver for iddddddd",Z.sessionId);const{flow_steps:J}=this.props;J&&console.log("🚀 ~ file: Inspector.js:210 ~ Inspector ~ render ~ flow_steps:",J);const Q=t&&!r||Y&&(!V||!G);let ee=e.default.createElement("div",{className:o.default["screenshot-controls"]},e.default.createElement(l.Tooltip,{title:F(z?"Hide Element Handles":"Show Element Handles"),placement:"topRight"},e.default.createElement(l.Switch,{checkedChildren:e.default.createElement(f.CheckCircleOutlined,null),unCheckedChildren:e.default.createElement(f.CloseCircleOutlined,null),defaultChecked:!1,onChange:()=>H(),disabled:$,style:{width:"40px"}})),e.default.createElement(l.Button,{icon:e.default.createElement(f.BarsOutlined,null),onClick:()=>this.handlePanel(this.state.showPanel)}),e.default.createElement(U,{value:T,style:{display:"flex",flexDirection:"column",position:"absolute",top:"150px",zIndex:"99"}},e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(1),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.SelectOutlined,null),onClick:()=>{this.screenshotInteractionChange(v)},type:T===v?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$,className:o.default.user_actions},1===this.state.activeIndex&&e.default.createElement("span",null,"Select Elements")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(2),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.SwapRightOutlined,null),onClick:()=>{this.screenshotInteractionChange(C)},type:T===C?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$,className:o.default.user_actions},2===this.state.activeIndex&&e.default.createElement("span",null,"Swipe By Coordinates")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(3),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.ScanOutlined,null),onClick:()=>{this.screenshotInteractionChange(A)},type:T===A?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$,className:o.default.user_actions},3===this.state.activeIndex&&e.default.createElement("span",null,"Tap By Coordinates")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(4),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.InfoOutlined,null),onClick:()=>{this.screenshotInteractionChange(g)},type:T===g?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$,className:o.default.user_actions},4===this.state.activeIndex&&e.default.createElement("span",null,"LongPress")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(5),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.DragOutlined,null),onClick:()=>{this.screenshotInteractionChange(N)},type:T===N?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$,className:o.default.user_actions},5===this.state.activeIndex&&e.default.createElement("span",null,"Drag & Drop")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(6),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.UpCircleOutlined,null),onClick:()=>{this.screenshotInteractionChange(M)},type:T===M?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,className:o.default.user_actions},6===this.state.activeIndex&&e.default.createElement("span",null,"Double Tap")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(7),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.ShrinkOutlined,null),onClick:()=>{this.screenshotInteractionChange(x)},type:T===x?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$,className:o.default.user_actions},7===this.state.activeIndex&&e.default.createElement("span",null,"Zoom")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(8),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.SlidersOutlined,null),onClick:()=>{this.screenshotInteractionChange(R)},type:T===R?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$,className:o.default.user_actions},8===this.state.activeIndex&&e.default.createElement("span",null,"Slider")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(9),onMouseOut:()=>this.setActiveIndex(0),className:o.default.user_actions,icon:e.default.createElement(f.FileAddOutlined,null),onClick:async()=>{if(T===y){this.screenshotInteractionChange(null);let e={session_id:Z.sessionId,"step-name":"select_file",status:"done"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)})}else this.screenshotInteractionChange(y)},type:T===y?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$},9===this.state.activeIndex&&e.default.createElement("span",null,"File Upload")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(10),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.DollarOutlined,null),onClick:()=>{this.screenshotInteractionChange(b)},type:T===b?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$,className:o.default.user_actions},10===this.state.activeIndex&&e.default.createElement("span",null,"Expected value")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(11),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.FundProjectionScreenOutlined,null),onClick:()=>{this.screenshotInteractionChange(B)},type:T===B?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$,className:o.default.user_actions},11===this.state.activeIndex&&e.default.createElement("span",null,"Take Screenshot")),e.default.createElement(l.Button,{onMouseOver:()=>this.setActiveIndex(12),onMouseOut:()=>this.setActiveIndex(0),icon:e.default.createElement(f.DollarOutlined,null),onClick:()=>{this.screenshotInteractionChange(w)},type:T===w?E.BUTTON.PRIMARY:E.BUTTON.DEFAULT,disabled:$,className:o.default.user_actions},12===this.state.activeIndex&&e.default.createElement("span",null,"Scratch")))),te=e.default.createElement("div",{className:o.default["inspector-main"],ref:e=>{this.screenAndSourceEl=e}},e.default.createElement("div",{id:"screenshotContainer",className:o.default["screenshot-container"],ref:e=>{this.screenshotEl=e}},ee,Q&&e.default.createElement(a.default,S({},this.props,{scaleRatio:this.state.scaleRatio})),r&&F("couldNotObtainScreenshot",{screenshotError:r}),!Q&&e.default.createElement(l.Spin,{size:"large",spinning:!0},e.default.createElement("div",{className:o.default.screenshotBox}))),e.default.createElement("div",{id:"sourceTreeContainer",className:o.default["interaction-tab-container"]},O&&e.default.createElement(c.default,this.props),e.default.createElement(l.Tabs,{activeKey:P,size:"small",onChange:e=>_(e),items:[{label:F("Source"),key:n.INTERACTION_MODE.SOURCE,children:e.default.createElement("div",{className:"action-row"},e.default.createElement("div",{style:{fontWeight:"bold"}},"FLOW TABLE:"),e.default.createElement("br",null),e.default.createElement("table",null,e.default.createElement("tr",null,e.default.createElement("th",null,"S No."),e.default.createElement("th",null,"Step"),e.default.createElement("th",null,"Step Name"),e.default.createElement("th",null,"Search By"),e.default.createElement("th",null,"Search By Value")),J&&J.map((t,n)=>e.default.createElement("tr",{key:n},e.default.createElement("td",null,n+1),e.default.createElement("td",null,t.step),e.default.createElement("td",null,t.step_name),e.default.createElement("td",null,t.search_by),e.default.createElement("td",null,t.search_by_value)))),e.default.createElement("div",{id:"selectedElementContainer",className:`${o.default["interaction-tab-container"]} ${o.default["element-detail-container"]} action-col`},e.default.createElement(l.Card,{title:e.default.createElement("span",null,e.default.createElement(f.TagOutlined,null)," ",F("selectedElement")),className:o.default["selected-element-card"]},X&&e.default.createElement(i.default,this.props),!X&&e.default.createElement("i",null,F("selectElementInSource")))))},{label:F("Commands"),key:n.INTERACTION_MODE.COMMANDS,children:e.default.createElement(l.Card,{title:e.default.createElement("span",null,e.default.createElement(f.ThunderboltOutlined,null)," ",F("Execute Commands")),className:o.default["interaction-tab-card"]},e.default.createElement(d.default,this.props))},{label:F("Gestures"),key:n.INTERACTION_MODE.GESTURES,children:$?e.default.createElement(l.Card,{title:e.default.createElement("span",null,e.default.createElement(f.HighlightOutlined,null)," ",F("Gesture Builder")),className:o.default["interaction-tab-card"]},e.default.createElement(h.default,this.props)):e.default.createElement(l.Card,{title:e.default.createElement("span",null,e.default.createElement(f.HighlightOutlined,null)," ",F("Saved Gestures")),className:o.default["interaction-tab-card"]},e.default.createElement(u.default,this.props))},{label:F("Session Information"),key:n.INTERACTION_MODE.SESSION_INFO,children:e.default.createElement(l.Card,{title:e.default.createElement("span",null,e.default.createElement(f.InfoCircleOutlined,null)," ",F("Session Information")),className:o.default["interaction-tab-card"]},e.default.createElement(m.default,this.props))}]})));return e.default.createElement("div",{className:o.default["inspector-container"]},e.default.createElement(s.default,this.props),te,e.default.createElement(l.Modal,{title:F("Session Inactive"),open:j,onOk:()=>L(),onCancel:()=>I(),okText:F("Keep Session Running"),cancelText:F("Quit Session")},e.default.createElement("p",null,F("Your session is about to expire"))),e.default.createElement(l.Modal,{title:F("methodCallResult",{methodName:k}),open:!!W,onOk:()=>D(null),onCancel:()=>D(null)},e.default.createElement("pre",null,e.default.createElement("code",null,W))))}}exports.default=L;
