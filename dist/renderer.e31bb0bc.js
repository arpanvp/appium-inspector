...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=s(require("react")),t=d(require("lodash")),l=require("./shared"),n=d(require("./Inspector.css")),a=require("antd"),r=require("../../polyfills"),c=require("@ant-design/icons"),i=require("../AntdTypes");function d(e){return e&&e.__esModule?e:{default:e}}function o(e){if("function"!=typeof WeakMap)return null;var t=new WeakMap,l=new WeakMap;return(o=function(e){return e?l:t})(e)}function s(e,t){if(!t&&e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var l=o(t);if(l&&l.has(e))return l.get(e);var n={},a=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var r in e)if("default"!==r&&Object.prototype.hasOwnProperty.call(e,r)){var c=a?Object.getOwnPropertyDescriptor(e,r):null;c&&(c.get||c.set)?Object.defineProperty(n,r,c):n[r]=e[r]}return n.default=e,l&&l.set(e,n),n}const u="NATIVE_APP",m="https://github.com/facebookarchive/WebDriverAgent/wiki/Class-Chain-Queries-Construction-Rules",f="https://github.com/facebookarchive/WebDriverAgent/wiki/Predicate-Queries-Construction-Rules",p=(t,l)=>l?e.default.createElement("div",{className:n.default["selected-element-table-cells"]},e.default.createElement(a.Tooltip,{title:"Copied!",trigger:"click"},e.default.createElement("span",{className:n.default["element-cell-copy"],onClick:()=>r.clipboard.writeText(t)},t))):e.default.createElement("div",{className:n.default["selected-element-table-cells"]},t),E=d=>{console.log("props inside the selected Element!!",d),console.log("props.hoveredElement$$$$$$$4!!",d.hoveredElement);const{applyClientMethod:o,contexts:s,currentContext:E,getFindElementsTimes:h,findElementsExecutionTimes:g,isFindingElementsTimes:y,selectedElement:b,selectedElementId:v,sourceXML:I,elementInteractionsNotAvailable:k,selectedElementSearchInProgress:C,t:N}=d;console.log("selectedElementId inside the selected Element!!",v);const A=(0,e.useRef)(),{attributes:w,classChain:x,predicateString:T,xpath:O}=b,R=C||y;N("Attribute"),N("Value");let P=t.default.toPairs(w).filter(([e])=>"path"!==e).map(([e,t])=>({key:e,value:t,name:e}));P.unshift({key:"elementId",value:v,name:"elementId"});let S=[{title:N("Find By"),dataIndex:"find",key:"find",width:100,render:e=>p(e,!1)},{title:N("Selector"),dataIndex:"selector",key:"selector",render:e=>p(e,!0)}];g.length>0&&S.push({title:N("Time"),dataIndex:"time",key:"time",align:"right",width:100,render:e=>p(e,!1)});let W=t.default.toPairs((0,l.getLocators)(w,I)).map(([e,t])=>({key:e,selector:t,find:e})),j=!1;if(0===W.length&&(j=!0),x&&E===u){const t=e.default.createElement("span",null,"-ios class chain",e.default.createElement("strong",null,e.default.createElement("a",{onClick:e=>e.preventDefault()||r.shell.openExternal(m)}," (docs)")));W.push({key:"-ios class chain",find:t,selector:x})}if(T&&E===u){const t=e.default.createElement("span",null,"-ios predicate string",e.default.createElement("strong",null,e.default.createElement("a",{onClick:e=>e.preventDefault()||r.shell.openExternal(f)}," (docs)")));W.push({key:"-ios predicate string",find:t,selector:T})}if(O){W.push({key:"xpath",find:"xpath",selector:O});let e=W.concat(P);console.log("🚀 ~ file: SelectedElement.js:169 ~ SelectedElement ~ sendData:",e)}g.length>0&&(W=g);let L=e.default.createElement(c.AimOutlined,null);return(!k&&!v||C)&&(L=e.default.createElement(c.LoadingOutlined,null)),e.default.createElement("div",null,k&&e.default.createElement(a.Row,{type:i.ROW.FLEX,gutter:10,className:n.default.selectedElemNotInteractableAlertRow},e.default.createElement(a.Col,null,e.default.createElement(a.Alert,{type:i.ALERT.INFO,message:N("interactionsNotAvailable"),showIcon:!0}))),e.default.createElement(a.Row,{justify:"center",type:i.ROW.FLEX,align:"middle",className:n.default.elementActions},e.default.createElement(a.Tooltip,{title:N("Tap")},e.default.createElement(a.Button,{disabled:R,icon:L,id:"btnTapElement",onClick:()=>o({methodName:"click",elementId:v})})),e.default.createElement(a.Button.Group,{className:n.default.elementKeyInputActions},e.default.createElement(a.Input,{className:n.default.elementKeyInput,disabled:R,placeholder:N("Enter Keys to Send"),allowClear:!0,onChange:e=>A.current=e.target.value}),e.default.createElement(a.Tooltip,{title:N("Send Keys")},e.default.createElement(a.Button,{disabled:R,id:"btnSendKeysToElement",icon:e.default.createElement(c.SendOutlined,null),onClick:()=>o({methodName:"sendKeys",elementId:v,args:[A.current||""]})})),e.default.createElement(a.Tooltip,{title:N("Clear")},e.default.createElement(a.Button,{disabled:R,id:"btnClearElement",icon:e.default.createElement(c.ClearOutlined,null),onClick:()=>o({methodName:"clear",elementId:v})})))),e.default.createElement("br",null),E===u&&j&&e.default.createElement("div",null,e.default.createElement(a.Alert,{message:N("usingXPathNotRecommended"),type:i.ALERT.WARNING,showIcon:!0}),e.default.createElement("br",null)),E===u&&s&&s.length>1&&e.default.createElement("div",null,e.default.createElement(a.Alert,{message:N("usingSwitchContextRecommended"),type:i.ALERT.WARNING,showIcon:!0}),e.default.createElement("br",null)),E!==u&&e.default.createElement("div",null,e.default.createElement(a.Alert,{message:N("usingWebviewContext"),type:i.ALERT.WARNING,showIcon:!0}),e.default.createElement("br",null)),s&&s.length>1&&e.default.createElement("div",null,(()=>{const{setContext:t}=d;return e.default.createElement(a.Tooltip,{title:N("contextSwitcher")},e.default.createElement(a.Select,{value:E,onChange:e=>{t(e),o({methodName:"switchContext",args:[e]})},className:n.default["context-selector"]},s.map(({id:t,title:l})=>e.default.createElement(a.Select.Option,{key:t,value:t},l?`${l} (${t})`:t))))})(),e.default.createElement("br",null),e.default.createElement("br",null)))};var h=E;exports.default=h;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=O(require("react")),t=require("lodash"),n=require("./shared"),a=require("antd"),s=y(require("./Screenshot")),l=y(require("./HeaderButtons")),o=y(require("./SelectedElement")),i=y(require("./Source")),r=y(require("./Inspector.css")),c=y(require("./RecordedActions")),d=y(require("./Commands")),u=y(require("./SavedGestures")),p=y(require("./GestureEditor")),h=y(require("./SessionInfo")),m=require("../../polyfills"),f=y(require("moment")),E=require("react-redux"),T=require("@ant-design/icons"),g=require("../AntdTypes");function y(e){return e&&e.__esModule?e:{default:e}}function I(e){if("function"!=typeof WeakMap)return null;var t=new WeakMap,n=new WeakMap;return(I=function(e){return e?n:t})(e)}function O(e,t){if(!t&&e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var n=I(t);if(n&&n.has(e))return n.get(e);var a={},s=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var l in e)if("default"!==l&&Object.prototype.hasOwnProperty.call(e,l)){var o=s?Object.getOwnPropertyDescriptor(e,l):null;o&&(o.get||o.set)?Object.defineProperty(a,l,o):a[l]=e[l]}return a.default=e,n&&n.set(e,a),a}function S(){return(S=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e}).apply(this,arguments)}const{SELECT:A,SWIPE:N,TAP:C,LONGPRESS:b,DRAG_AND_DROP:B,DOUBLE_TAP:R,ZOOMIN:v,SLIDE:P,FILE_UPLOAD:w,EXPECTED_VALUE:U,ROTATE:_,TAKE_SCREENSHOT:x,SCRATCH:k,HIDE_KEYBOARD:D,GET_DEVICE_TIME:j,GET_CLIPBOARD:M,LOCK:L,UNLOCK:F,SHAKE:Y}=n.SCREENSHOT_INTERACTION_MODE,q=a.Button.Group,G=870,J=610,W=500,{Option:H}=a.Select,z=1e3;function K(e){let t=document.createElement("a");t.setAttribute("href","data:application/xml;charset=utf-8,"+encodeURIComponent(e)),t.setAttribute("download","source.xml"),t.style.display="none",document.body.appendChild(t),t.click(),document.body.removeChild(t)}class V extends e.Component{constructor(){super(),this.didInitialResize=!1,this.state={scaleRatio:1,activeIndex:0,nestedDropIndex:0,showPanel:!1,currentSelection:"Select Elements",step_array:[],total_array:[],isLongPress:!1,action:"",mode_orientation:""},this.screenAndSourceEl=null,this.lastScreenshot=null,this.screenshotEl=null,this.updateSourceTreeWidth=(0,t.debounce)(this.updateSourceTreeWidth.bind(this),50),this.updateScaleRatio=(0,t.debounce)(this.updateScaleRatio.bind(this),500),this.mjpegStreamCheckInterval=null}updateScaleRatio(){const e=this.screenshotEl.querySelector("img");this.setState({scaleRatio:this.props.windowSize.width/e.offsetWidth})}updateSourceTreeWidth(){if(!this.screenAndSourceEl)return;const e=this.screenAndSourceEl.querySelector("#screenshotContainer"),t=this.screenAndSourceEl.querySelector("#screenshotContainer img#screenshot");if(!t)return;const n=t.getBoundingClientRect(),a=e.getBoundingClientRect();if(e.style.flexBasis=`${n.width}px`,n.height<a.height){const t=a.height/n.height*n.width;e.style.maxWidth=t>W?`${W}px`:`${t}px`}else n.width<a.width&&(e.style.maxWidth=`${n.width}px`);this.updateScaleRatio()}componentDidMount(){const e=window.innerHeight,t=window.innerWidth,n=e<J||t<G;if(!this.didInitialResize&&n){const n=t<G?G:t,a=e<J?J:e;window.resizeTo(n,a)}this.didInitialResize=!0,console.log("props in the inspector",this.props),this.props.applyClientMethod({methodName:"getPageSource",ignoreResult:!0}),this.props.getSavedActionFramework(),this.props.runKeepAliveLoop(),window.addEventListener("resize",this.updateSourceTreeWidth),this.props.setSessionTime(Date.now()),this.props.mjpegScreenshotUrl&&(this.mjpegStreamCheckInterval=setInterval(this.checkMjpegStream.bind(this),z))}async checkMjpegStream(){const{mjpegScreenshotUrl:e,isAwaitingMjpegStream:t,setAwaitingMjpegStream:n}=this.props,a=new Image;a.src=e;let s=!1;try{await a.decode(),s=!0}catch(l){}s&&t?(n(!1),this.updateSourceTreeWidth()):s||t||n(!0)}componentDidUpdate(){const{screenshot:e}=this.props;e!==this.lastScreenshot&&(this.updateSourceTreeWidth(),this.lastScreenshot=e)}componentWillUnmount(){this.mjpegStreamCheckInterval&&(clearInterval(this.mjpegStreamCheckInterval),this.mjpegStreamCheckInterval=null)}handlePanel(e){this.setState({showPanel:!this.state.showPanel})}screenshotInteractionChange(e,t){const{selectScreenshotInteractionMode:n,clearSwipeAction:a}=this.props;a(),n(e),this.setState({currentSelection:t})}async handleActions(e,t){const{driver:n}=this.props;console.log("🚀 ~ file: Inspector.js:223 ~ handleActions ~ action:",e);let a={session_id:n.sessionId,"step-name":t,action:e};this.setState({nestedDropIndex:0}),this.setActiveIndex(0),console.log("🚀 ~ file: Inspector.js:219 ~ Inspector ~ handleActions ~ postdata:",a),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}).then(e=>{console.log("API response:",e),a.response=e}).catch(e=>{console.error("API error:",e)});let s={session_id:n.sessionId,"step-name":"steps"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)})}setActiveIndex(e){this.setState({activeIndex:e})}async hideKeyboard(){const{driver:e,screenshotInteractionMode:t}=this.props;e.client.hideKeyboard(),console.log("hide keyboard^^^^^^^^^^^^^^^^"),this.props.applyClientMethod({methodName:"getPageSource",ignoreResult:!0});let n={session_id:e.sessionId,"step-name":"hideKeyboard"};console.log("🚀 ~ file: Inspector.js:219 ~ Inspector ~ hideKeyboard ~ postdata:",n),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)}).then(e=>{console.log("API response:",e),n.response=e}).catch(e=>{console.error("API error:",e)})}async getDeviceTime(){const{driver:e}=this.props,t=await e.client.getDeviceTime();console.log("get device timeeeeeeeeeeeeeeeeee",t);const n=f.default.utc(t).utcOffset("+05:30").format("YYYY-MM-DD HH:mm:ss");let a={session_id:e.sessionId,"step-name":"getDeviceTime"};console.log("🚀 ~ file: Inspector.js:219 ~ Inspector ~ getDeviceTime ~ postdata:",a),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}).then(e=>{console.log("API response:",e),a.response=e}).catch(e=>{console.error("API error:",e)}),alert(n)}async isLocked(){const{driver:e}=this.props,t=await e.client.lock();console.log("🚀 ~ file: Inspector.js:286 ~ isLocked ~ islocked:",t),await this.props.applyClientMethod({methodName:"getPageSource"})}async shakeBooty(){console.log("this is shake shake ittt");const{driver:e}=this.props,t=await e.client.shake();console.log("🚀 ~ file: Inspector.js:295 ~ shakeBooty ~ isShake:",t)}render(){const{screenshot:t,screenshotError:o,selectedElement:i={},quitSession:m,showRecord:f,screenshotInteractionMode:E,visibleCommandMethod:y,selectedInteractionMode:I,selectInteractionMode:O,setVisibleCommandResult:F,showKeepAlivePrompt:q,keepSessionAlive:G,sourceXML:J,t:W,visibleCommandResult:H,mjpegScreenshotUrl:z,isAwaitingMjpegStream:K,toggleShowCentroids:V,showCentroids:$,isGestureEditorVisible:X,toggleShowAttributes:Z,isSourceRefreshOn:Q,applyClientMethod:ee}=this.props,{path:te}=i,{driver:ne}=this.props,{flow_steps:ae}=this.props,se=["Return","Space","BackSpace","Enter","Back","Search","Call","Endcall"];ae&&(console.log("🚀 ~ file: Inspector.js:210 ~ Inspector ~ render ~ flow_steps:",ae),this.state.total_array=ae.steps.steps),console.log("driver for iddddddd",ne),ne.client.getOrientation().then(e=>{console.log("🚀 ~ file: Inspector.js:363 ~ driver.client.getOrientation ~ res:",e),this.setState({mode_orientation:e})});const le=t&&!o||z&&(!Q||!K);let oe=e.default.createElement("div",{className:r.default["screenshot-controls"]},e.default.createElement(a.Tooltip,{title:W($?"Hide Element Handles":"Show Element Handles"),placement:"topRight"},e.default.createElement(a.Switch,{checkedChildren:e.default.createElement(T.CheckCircleOutlined,null),unCheckedChildren:e.default.createElement(T.CloseCircleOutlined,null),defaultChecked:!1,onChange:()=>V(),disabled:X,style:{width:"40px"}})),le&&e.default.createElement("div",null,e.default.createElement(a.Button,{icon:e.default.createElement(T.SelectOutlined,null),onClick:()=>{this.screenshotInteractionChange(A,"Select Elements")},type:E===A?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Select Elements")),e.default.createElement("div",{onMouseOver:()=>this.setActiveIndex(1),onMouseOut:()=>this.setActiveIndex(0),style:{textAlign:"center",padding:"5px",borderBottom:"1px solid grey",position:"relative",cursor:"pointer"}},e.default.createElement(T.LikeOutlined,{style:{fontSize:"20px"}}),e.default.createElement("div",null,"Gestures"),1===this.state.activeIndex&&e.default.createElement("div",{style:{display:"flex",flexDirection:"column",position:"absolute",zIndex:"999",left:"100%",top:"10%"}},e.default.createElement(a.Button,{icon:e.default.createElement(T.SwapRightOutlined,null),onClick:()=>{this.screenshotInteractionChange(N,"Swipe by coordinates")},type:E===N?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Swipe By Coordinates")),e.default.createElement(a.Button,{icon:e.default.createElement(T.ScanOutlined,null),onClick:()=>{this.screenshotInteractionChange(C,"Tap by coordinates")},type:E===C?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Tap By Coordinates")),e.default.createElement(a.Button,{icon:e.default.createElement(T.InfoOutlined,null),onClick:()=>{this.screenshotInteractionChange(b,"Longpress")},type:E===b?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"LongPress")),e.default.createElement(a.Button,{icon:e.default.createElement(T.DragOutlined,null),onClick:()=>{this.screenshotInteractionChange(B,"Drag & Drop")},type:E===B?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Drag & Drop")),e.default.createElement(a.Button,{icon:e.default.createElement(T.UpCircleOutlined,null),onClick:()=>{this.screenshotInteractionChange(R,"Double tap")},type:E===R?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,className:r.default.user_actions},e.default.createElement("span",null,"Double Tap")),e.default.createElement(a.Button,{icon:e.default.createElement(T.ShrinkOutlined,null),onClick:()=>{this.screenshotInteractionChange(v,"Zoom")},type:E===v?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Zoom")),e.default.createElement(a.Button,{icon:e.default.createElement(T.SlidersOutlined,null),onClick:()=>{this.screenshotInteractionChange(P,"Slider")},type:E===P?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Slider")),e.default.createElement(a.Button,{icon:e.default.createElement(T.LockOutlined,null),onClick:()=>{this.screenshotInteractionChange(L,"Lock"),this.isLocked()},type:E===L?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Lock")))),e.default.createElement("div",{onMouseOver:()=>this.setActiveIndex(2),onMouseOut:()=>this.setActiveIndex(0),style:{textAlign:"center",padding:"5px",borderBottom:"1px solid grey",position:"relative",cursor:"pointer"}},e.default.createElement(T.EditOutlined,{style:{fontSize:"20px"}}),e.default.createElement("div",null,"Actions"),2===this.state.activeIndex&&e.default.createElement("div",{style:{display:"flex",flexDirection:"column",position:"absolute",zIndex:"999",left:"100%",top:"10%"}},e.default.createElement(a.Button,{icon:e.default.createElement(T.DollarOutlined,null),onClick:()=>{this.screenshotInteractionChange(U,"Expected Value")},type:E===U?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Expected value")),e.default.createElement(a.Button,{icon:e.default.createElement(T.FundProjectionScreenOutlined,null),onClick:()=>{this.screenshotInteractionChange(x,"Take screenshot")},type:E===x?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Take Screenshot")),e.default.createElement(a.Button,{icon:e.default.createElement(T.DollarOutlined,null),onClick:()=>{this.screenshotInteractionChange(k,"Scratch")},type:E===k?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Scratch")),e.default.createElement(a.Button,{icon:e.default.createElement(T.CaretDownOutlined,null),onClick:async()=>{this.screenshotInteractionChange(D,"Hide keyword"),this.hideKeyboard();let e={session_id:ne.sessionId,"step-name":"steps"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await ee({methodName:"getPageSource"})},type:E===D?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Hide Keyboard")),e.default.createElement(a.Button,{icon:e.default.createElement(T.FieldTimeOutlined,null),onClick:async()=>{this.screenshotInteractionChange(j,"Get Device Time"),this.getDeviceTime();let e={session_id:ne.sessionId,"step-name":"steps"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await ee({methodName:"getPageSource"})},type:E===j?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Get Device Time")),e.default.createElement(a.Button,{icon:e.default.createElement(T.PaperClipOutlined,null),onClick:async()=>{this.screenshotInteractionChange(M,"Get clipboard"),await ee({methodName:"getPageSource"})},type:E===M?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Get clipboard")),e.default.createElement(a.Button,{icon:e.default.createElement(T.RotateRightOutlined,null),onClick:async()=>{await ne.client.setOrientation("LANDSCAPE")},type:E===_?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Rotate")),e.default.createElement(a.Button,{icon:e.default.createElement(T.NotificationOutlined,null),onClick:async()=>{await ne.client.openNotifications();let e={session_id:ne.sessionId,"step-name":"notification"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)});let t={session_id:ne.sessionId,"step-name":"steps"};console.log("🚀 ~ file: Inspector.js:440 ~ Inspector ~ onClick={async ~ driver.sessionId:",ne.sessionId),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await ee({methodName:"getPageSource"})},type:E===_?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Open Notifications")),this.state.isInput?e.default.createElement("div",null,e.default.createElement(a.Input,{placeholder:"enter bundle id",onChange:e=>this.setState({inputBundleId:e.target.value})}),e.default.createElement(a.Button,{onClick:async()=>{await ne.client.activateApp(this.state.inputBundleId);let e={session_id:ne.sessionId,"step-name":"switch_app",bundle_id:this.state.inputBundleId};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)});let t={session_id:ne.sessionId,"step-name":"steps"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await ee({methodName:"getPageSource"}),this.setState({isInput:!1,inputBundleId:""})},style:{backgroundColor:"blue"}},"Activate App"),e.default.createElement(a.Button,{icon:e.default.createElement(T.AimOutlined,null),onClick:async()=>{await ne.client.resetApp()},disabled:X,className:r.default.user_actions}," ",e.default.createElement("span",null,"Reset App"))):e.default.createElement(a.Button,{icon:e.default.createElement(T.SwitcherOutlined,null),onClick:()=>this.setState({isInput:!0}),type:E===_?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Switch App")))),e.default.createElement("div",{onMouseOver:()=>this.setActiveIndex(3),onMouseOut:()=>this.setActiveIndex(0),style:{textAlign:"center",padding:"5px",borderBottom:"1px solid grey",position:"relative",cursor:"pointer"}},e.default.createElement(T.HeatMapOutlined,{style:{fontSize:"20px"}}),e.default.createElement("div",null,"Assertions"),3===this.state.activeIndex&&e.default.createElement("div",{style:{display:"flex",flexDirection:"column",position:"absolute",zIndex:"999",left:"100%",top:"10%"}},e.default.createElement(a.Button,{className:r.default.user_actions,icon:e.default.createElement(T.FileAddOutlined,null),onClick:async()=>{if(E===w){this.screenshotInteractionChange(null,null);let e={session_id:ne.sessionId,"step-name":"select_file",status:"done"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)})}else this.screenshotInteractionChange(w,"File Upload")},type:E===w?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X},e.default.createElement("span",null,"File Upload")),e.default.createElement(a.Button,{icon:e.default.createElement(T.DollarOutlined,null),onClick:()=>{this.screenshotInteractionChange(U,"Expected Value")},type:E===U?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Expected value")),e.default.createElement(a.Button,{icon:e.default.createElement(T.FundProjectionScreenOutlined,null),onClick:()=>{this.screenshotInteractionChange(x,"Take screenshot")},type:E===x?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Take Screenshot")),e.default.createElement(a.Button,{icon:e.default.createElement(T.DollarOutlined,null),onClick:()=>{this.screenshotInteractionChange(k,"Scratch")},type:E===k?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Scratch")),e.default.createElement(a.Button,{icon:e.default.createElement(T.CaretDownOutlined,null),onClick:async()=>{this.screenshotInteractionChange(D,"Hide keyword"),this.hideKeyboard();let e={session_id:ne.sessionId,"step-name":"steps"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await ee({methodName:"getPageSource"})},type:E===D?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Hide Keyboard")),e.default.createElement(a.Button,{icon:e.default.createElement(T.FieldTimeOutlined,null),onClick:async()=>{this.screenshotInteractionChange(j,"Get Device Time"),this.getDeviceTime();let e={session_id:ne.sessionId,"step-name":"steps"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await ee({methodName:"getPageSource"})},type:E===j?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Get Device Time")),e.default.createElement(a.Button,{icon:e.default.createElement(T.PaperClipOutlined,null),onClick:async()=>{this.screenshotInteractionChange(M,"Get clipboard"),await ee({methodName:"getPageSource"})},type:E===M?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Get clipboard")),e.default.createElement(a.Button,{icon:e.default.createElement(T.ShakeOutlined,null),onClick:()=>{this.screenshotInteractionChange(Y,"shake"),this.shakeBooty()},type:E===Y?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Shake")),"PORTRAIT"==this.state.mode_orientation?e.default.createElement(a.Button,{icon:e.default.createElement(T.RotateRightOutlined,null),onClick:async()=>{await ne.client.setOrientation("LANDSCAPE"),await ee({methodName:"getPageSource"});let e={session_id:ne.sessionId,"step-name":"rotate",action:"landscape"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)});let t={session_id:ne.sessionId,"step-name":"steps"};console.log("🚀 ~ file: Inspector.js:440 ~ Inspector ~ onClick={async ~ driver.sessionId:",ne.sessionId),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)})},type:E===_?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Rotate/Landscape")):e.default.createElement(a.Button,{icon:e.default.createElement(T.RotateRightOutlined,null),onClick:async()=>{await ne.client.setOrientation("PORTRAIT");let e={session_id:ne.sessionId,"step-name":"rotate",action:"portrait"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)});let t={session_id:ne.sessionId,"step-name":"steps"};console.log("🚀 ~ file: Inspector.js:440 ~ Inspector ~ onClick={async ~ driver.sessionId:",ne.sessionId),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await ee({methodName:"getPageSource"})},type:E===_?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Rotate/Potrait")),e.default.createElement(a.Button,{icon:e.default.createElement(T.NotificationOutlined,null),onClick:async()=>{await ne.client.openNotifications();let e={session_id:ne.sessionId,"step-name":"notification"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)});let t={session_id:ne.sessionId,"step-name":"steps"};console.log("🚀 ~ file: Inspector.js:440 ~ Inspector ~ onClick={async ~ driver.sessionId:",ne.sessionId),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await ee({methodName:"getPageSource"})},type:E===_?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Open Notifications")),this.state.isInput?e.default.createElement("div",null,e.default.createElement(a.Input,{placeholder:"enter bundle id",onChange:e=>this.setState({inputBundleId:e.target.value})}),e.default.createElement(a.Button,{onClick:async()=>{await ne.client.activateApp(this.state.inputBundleId);let e={session_id:ne.sessionId,"step-name":"switch_app",bundle_id:this.state.inputBundleId};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)});let t={session_id:ne.sessionId,"step-name":"steps"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await ee({methodName:"getPageSource"}),this.setState({isInput:!1,inputBundleId:""})},style:{backgroundColor:"blue"}},"Activate App")):e.default.createElement(a.Button,{icon:e.default.createElement(T.SwitcherOutlined,null),onClick:()=>this.setState({isInput:!0}),type:E===_?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:X,className:r.default.user_actions},e.default.createElement("span",null,"Switch App")),e.default.createElement(a.Button,{icon:e.default.createElement(T.AimOutlined,null),onClick:async()=>{await ne.client.resetApp()},disabled:X,className:r.default.user_actions}," ",e.default.createElement("span",null,"Reset App")))),e.default.createElement("div",{onMouseOver:()=>this.setActiveIndex(4),onMouseOut:()=>this.setActiveIndex(0),style:{textAlign:"center",padding:"5px",borderBottom:"1px solid grey",position:"relative",cursor:"pointer"}},e.default.createElement(T.EditOutlined,{style:{fontSize:"20px"}}),e.default.createElement("div",null,"Device Specific Actions"),4===this.state.activeIndex&&e.default.createElement("div",{style:{display:"flex",flexDirection:"column",position:"absolute",zIndex:"999",left:"100%",top:"10%"}},e.default.createElement(a.Button,{icon:e.default.createElement(T.FundProjectionScreenOutlined,null),type:E===x?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,onMouseOver:()=>this.setState({nestedDropIndex:1}),className:r.default.user_actions},e.default.createElement("span",null," long press key")),e.default.createElement(a.Button,{icon:e.default.createElement(T.FundProjectionScreenOutlined,null),type:E===x?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,onMouseOver:()=>this.setState({nestedDropIndex:2}),className:r.default.user_actions},e.default.createElement("span",null,"press key")),1===this.state.nestedDropIndex&&e.default.createElement("div",{style:{display:"flex",flexDirection:"column",position:"absolute",zIndex:"1999",left:"100%",top:"10%"}},e.default.createElement("div",null,se.map((t,n)=>e.default.createElement(a.Button,{style:{width:"100%"},key:n,onClick:async()=>await this.handleActions(t,"long_press_key")},t)))),2===this.state.nestedDropIndex&&e.default.createElement("div",{style:{display:"flex",flexDirection:"column",position:"absolute",zIndex:"1999",left:"100%",top:"10%"}},e.default.createElement("div",{style:{width:"100%"}},se.map((t,n)=>e.default.createElement(a.Button,{style:{width:"100%"},key:n,onClick:async()=>await this.handleActions(t,"press_key")},t)))))))),ie=e.default.createElement("div",{className:r.default["inspector-main"],ref:e=>{this.screenAndSourceEl=e}},e.default.createElement("div",{id:"screenshotContainer",className:r.default["screenshot-container"],ref:e=>{this.screenshotEl=e}},oe,le&&e.default.createElement("div",{style:{display:"flex",flexDirection:"column"}},null!==this.state.currentSelection&&e.default.createElement("div",{style:{textAlign:"center",color:"white",fontWeight:"bold",background:"rgb(24, 119, 242)",width:"max-content",borderRadius:"5px",padding:"10px",margin:"auto"}},"Current Selection : ",this.state.currentSelection),e.default.createElement(s.default,S({},this.props,{scaleRatio:this.state.scaleRatio}))),o&&W("couldNotObtainScreenshot",{screenshotError:o}),!le&&e.default.createElement(a.Spin,{size:"large",spinning:!0},e.default.createElement("div",{className:r.default.screenshotBox}))),e.default.createElement("div",{id:"sourceTreeContainer",className:r.default["interaction-tab-container"]},f&&e.default.createElement(c.default,this.props),e.default.createElement(a.Tabs,{activeKey:I,size:"small",onChange:e=>O(e),items:[{label:W("Source"),key:n.INTERACTION_MODE.SOURCE,children:e.default.createElement("div",{className:"action-row"},e.default.createElement("div",{style:{fontWeight:"bold"}},"FLOW TABLE:"),e.default.createElement("div",{style:{width:"100%",overflowX:"auto",overflowY:"auto"}},e.default.createElement("table",null,e.default.createElement("tr",null,e.default.createElement("th",null,"S No."),e.default.createElement("th",null,"Step"),e.default.createElement("th",null,"Step Name"),e.default.createElement("th",null,"Search By"),e.default.createElement("th",null,"Search By Value")),this.state.total_array&&this.state.total_array.map((t,n)=>e.default.createElement("tr",{key:n},e.default.createElement("td",null,n+1),e.default.createElement("td",null,t.step),e.default.createElement("td",null,t.step_name),e.default.createElement("td",null,t.search_by),e.default.createElement("td",{style:{maxWidth:"200px",wordWrap:"break-word"}},t.search_by_value))))))},{label:W("Commands"),key:n.INTERACTION_MODE.COMMANDS,children:e.default.createElement(a.Card,{title:e.default.createElement("span",null,e.default.createElement(T.ThunderboltOutlined,null)," ",W("Execute Commands")),className:r.default["interaction-tab-card"]},e.default.createElement(d.default,this.props))},{label:W("Gestures"),key:n.INTERACTION_MODE.GESTURES,children:X?e.default.createElement(a.Card,{title:e.default.createElement("span",null,e.default.createElement(T.HighlightOutlined,null)," ",W("Gesture Builder")),className:r.default["interaction-tab-card"]},e.default.createElement(p.default,this.props)):e.default.createElement(a.Card,{title:e.default.createElement("span",null,e.default.createElement(T.HighlightOutlined,null)," ",W("Saved Gestures")),className:r.default["interaction-tab-card"]},e.default.createElement(u.default,this.props))},{label:W("Session Information"),key:n.INTERACTION_MODE.SESSION_INFO,children:e.default.createElement(a.Card,{title:e.default.createElement("span",null,e.default.createElement(T.InfoCircleOutlined,null)," ",W("Session Information")),className:r.default["interaction-tab-card"]},e.default.createElement(h.default,this.props))}]})));return e.default.createElement("div",{className:r.default["inspector-container"]},e.default.createElement(l.default,this.props),ie,e.default.createElement(a.Modal,{title:W("Session Inactive"),open:q,onOk:()=>G(),onCancel:()=>m(),okText:W("Keep Session Running"),cancelText:W("Quit Session")},e.default.createElement("p",null,W("Your session is about to expire"))),e.default.createElement(a.Modal,{title:W("methodCallResult",{methodName:y}),open:!!H,onOk:()=>F(null),onCancel:()=>F(null)},e.default.createElement("pre",null,e.default.createElement("code",null,H))))}}exports.default=V;
