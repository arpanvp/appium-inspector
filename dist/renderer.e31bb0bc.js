<<<<<<< HEAD
process.env.HMR_PORT=44947;process.env.HMR_HOSTNAME="localhost";// modules are defined as an array
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=u(require("react")),t=i(require("./HighlighterRects")),a=require("antd"),n=i(require("bluebird")),o=i(require("./Inspector.css")),l=require("./shared"),r=require("react-icons/io5"),s=require("react-icons/bi");function i(e){return e&&e.__esModule?e:{default:e}}function c(e){if("function"!=typeof WeakMap)return null;var t=new WeakMap,a=new WeakMap;return(c=function(e){return e?a:t})(e)}function u(e,t){if(!t&&e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var a=c(t);if(a&&a.has(e))return a.get(e);var n={},o=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var l in e)if("default"!==l&&Object.prototype.hasOwnProperty.call(e,l)){var r=o?Object.getOwnPropertyDescriptor(e,l):null;r&&(r.get||r.set)?Object.defineProperty(n,l,r):n[l]=e[l]}return n.default=e,a&&a.set(e,n),n}function d(){return(d=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e}).apply(this,arguments)}const{POINTER_UP:y,POINTER_DOWN:p,PAUSE:E,POINTER_MOVE:f}=l.POINTER_TYPES,{TAP:m,SELECT:N,SLIDE:x,SWIPE:T,LONGPRESS:O,DRAG_AND_DROP:S,DOUBLE_TAP:h,SLIDE_SWIPE:g,ZOOMIN:_,SELECT_LONG:I,SELECT_DOUBLE:A,FILE_UPLOAD:D,SELECT_FILE:w,EXPECTED_VALUE:R,TAKE_SCREENSHOT:b,SCRATCH:P,ROTATE:v}=l.SCREENSHOT_INTERACTION_MODE,U={FILLED:"filled",NEW_DASHED:"newDashed",WHOLE:"whole",DASHED:"dashed",DRAG:"drag"},M=i=>{const{screenshot:c,mjpegScreenshotUrl:u,methodCallInProgress:v,driver:M,selectScreenshotInteractionMode:L,screenshotInteractionMode:C,step_object:B,swipeStart:k,swipeEnd1:j,swipeStart1:G,swipeEnd:F,scaleRatio:H,selectedTick:W,selectedInteractionMode:$,applyClientMethod:q,t:K,hoveredElement:V,locatorTestElement:X}=i,[Y,Z]=(0,e.useState)(null),[z,J]=(0,e.useState)(null),[Q,ee]=(0,e.useState)({}),[te,ae]=(0,e.useState)([]),[ne,oe]=(0,e.useState)(!1);(0,e.useEffect)(()=>{if(V&&V.attributes&&V.attributes.bounds){const e=V.attributes.bounds;console.log("coordinatestring",e);const t=e.match(/\d+/g);if(t.length>=4){parseInt(t[0],10),parseInt(t[1],10);const e=parseInt(t[2],10),a=parseInt(t[3],10),n=Math.round(e),o=Math.round(a);Z(n),J(o)}}},[V]);const le=(0,e.useRef)(),[re,se]=(0,e.useState)(),[ie,ce]=(0,e.useState)(),[ue,de]=(0,e.useState)(!1),[ye,pe]=(0,e.useState)({});let[Ee,fe]=(0,e.useState)({x:0,y:0,scale:1});le.current,(0,e.useRef)();const me=()=>{console.log("inside the use file upload function!!!!!!");const{POINTER_NAME:e,DURATION_1:t,DURATION_2:a,BUTTON:n}=l.DEFAULT_TAP,{clearSwipeAction:o}=i;q({methodName:m,args:[{[e]:[{type:f,duration:t,x:re,y:ie},{type:p,button:n},{type:E,duration:a},{type:y,button:n}]}]}),o(),L(D)},Ne=async()=>{const{LONGPRESS_POINTER_NAME:e,LONGPRESS_DURATION_1:t,LONGPRESS_DURATION_2:a,LONGPRESS_BUTTON:n}=l.DEFAULT_LONGPRESS;let o={methodName:m,args:{[e]:[{type:f,duration:t,x:re,y:ie},{type:p,button:n},{type:E,duration:a},{type:y,button:n}]}};await q(o),L(O)},xe=()=>{const{POINTER_NAME:e,DURATION_1:t,DURATION_2:a,BUTTON:n}=l.DEFAULT_TAP;q({methodName:m,args:[{[e]:[{type:f,duration:t,x:re,y:ie},{type:p,button:n},{type:E,duration:a},{type:y,button:n}]}]});setTimeout(()=>{q({methodName:m,args:[{[e]:[{type:f,duration:t,x:re,y:ie},{type:p,button:n},{type:E,duration:a},{type:y,button:n}]}]})},50),L(h)},Te=async e=>{console.log("🚀 ~ file: Screenshot.js:293 ~ scratchCard ~ e:",e),console.log("scratching"),!0===ne&&await Ie(e)},Oe=async e=>{const{clearSwipeAction:t}=i,{POINTER_NAME:a,DURATION_1:n,DURATION_2:o,BUTTON:r,ORIGIN:s}=l.DEFAULT_SWIPE;await q({methodName:T,args:{[a]:[{type:f,duration:n,x:k.x,y:k.y},{type:p,button:r},{type:f,duration:o,origin:s,x:e.x,y:e.y},{type:y,button:r}]}}),t(),B&&console.log("🚀 ~ file: Screenshot.js:97 ~ Screenshot ~ step_object:",B)},Se=async e=>{console.log("🚀 ~ file: Screenshot.js:332 ~ handleDoSwipeSlide ~ props:",i);let t=i.selectedElement.xpath;console.log("🚀 ~ file: Screenshot.js:304 ~ handleDoSwipeSlide ~ xpath:",t);const{clearSwipeAction:a}=i,{POINTER_NAME:n,DURATION_1:o,DURATION_2:r,BUTTON:s,ORIGIN:c}=l.DEFAULT_SWIPE;let u={methodName:T,args:{[n]:[{type:f,duration:o,x:k.x,y:k.y},{type:p,button:s},{type:f,duration:r,origin:c,x:e.x,y:e.y},{type:y,button:s}]}};t&&(u.xpath=t),await q(u),L(x),a()},he=async e=>{const{clearSwipeAction:t}=i,{POINTER_NAME:a,DURATION_1:n,DURATION_2:o,BUTTON:r,ORIGIN:s}=l.DEFAULT_DRAG_AND_DROP;await q({methodName:m,args:{[a]:[{type:f,duration:n,origin:s,x:k.x,y:k.y},{type:p,button:r},{type:E,duration:o},{type:f,duration:o,origin:s,x:e.x,y:e.y},{type:y,button:r}]}}),t()},ge=async(e,t)=>{const{clearSwipeAction:a}=i,{POINTER_NAME1:n,POINTER_NAME2:o,DURATION_1:r,DURATION_2:s,BUTTON:c,ORIGIN:u}=l.DEFAULT_ZOOM;console.log(`swipeStart.x : ${k.x}, swipeStart.y : : ${k.y} , swipeEndLocal1.x : ${t.x} , swipeEndLocal1.y : ${t.y} , swipeStart1.x : ${G.x} , swipeStart1.y : ${G.y}, swipeEndLocal.x : ${e.x} , swipeEndLocal.y : ${e.y}`),e&&t&&(await q({methodName:T,args:{[n]:[{type:f,duration:r,x:k.x,y:k.y},{type:p,button:c},{type:f,duration:s,origin:u,x:t.x,y:t.y},{type:y,button:c}],[o]:[{type:f,duration:r,x:G.x,y:G.y},{type:p,button:c},{type:f,duration:s,origin:u,x:e.x,y:e.y},{type:y,button:c}]}}),a())},_e=async e=>{const{POINTER_NAME:t,DURATION_1:a,DURATION_2:n,BUTTON:o,ORIGIN:r}=l.DEFAULT_SWIPE;let s={methodName:m,args:{[t]:[{type:f,duration:a,origin:r,x:k.x,y:k.y},{type:p,button:o},{type:E,duration:n}]},xpath:e.xpath,expected_value:e.expected_value};await q(s)},Ie=e=>{const{clearSwipeAction:t}=i,{POINTER_NAME1:a,POINTER_NAME2:n,DURATION_1:o,DURATION_2:r,BUTTON:s,ORIGIN:c}=l.DEFAULT_ZOOM;if(C!==N){const l=e.nativeEvent.offsetX,i=e.nativeEvent.offsetY,u=l*H,d=i*H;if(se(Math.round(u)),ce(Math.round(d)),C===P&&(ae(e=>[...e,{x:Math.round(u),y:Math.round(d)}]),te.length>250)){console.log("🚀 ~ file: Screenshot.js:440 ~ handleMouseMove ~ coordinates.length:",te);let e={methodName:T,args:{[a]:[{type:f,duration:o,x:te[0].x,y:te[0].y},{type:p,button:s},{type:f,duration:r,origin:c,x:te[80].x,y:te[80].y},{type:y,button:s}],[n]:[{type:f,duration:o,x:te[80].x,y:te[80].y},{type:p,button:s},{type:f,duration:r,origin:c,x:te[160].x,y:te[160].y},{type:y,button:s}]}};q(e),t(),ae([]),oe(!1)}}console.log("🚀 ~ file: Screenshot.js:406 ~ handleMouseMove ~ e:",e)},Ae={};[m,T].includes(C)||W?Ae.cursor="crosshair":[S].includes(C)||W?Ae.cursor="move":Ae.cursor="pointer",([_,g].includes(C)||W)&&(Ae.cursor="crosshair");let De=null;C!==T||k&&F||(k?F||(De=K("Click swipe end point")):De=K("Click swipe start point"));const we=u||`data:image/gif;base64,${c}`,Re=e.default.createElement("img",{src:we,id:"screenshot",className:o.default.screenimage}),be=(()=>{const{showGesture:e}=i,{FILLED:t,NEW_DASHED:a,WHOLE:n,DASHED:o}=U,l={pointerDown:n,pointerUp:o};return e?e.map(e=>{let r=o;const s=[];for(const i of e.ticks){if(i.type===E)continue;const c=s.length;r=i.type!==f?l[i.type]:r,i.type===f&&void 0!==i.x&&void 0!==i.y&&s.push({id:i.id,type:r,x:i.x,y:i.y,color:e.color}),0===c?i.type===p&&s.push({id:i.id,type:t,x:0,y:0,color:e.color}):(i.type===p&&s[c-1].type===o&&(s[c-1].type=t),i.type===y&&s[c-1].type===n&&(s[c-1].type=a))}return s}):null})();return e.default.createElement(a.Spin,{size:"large",spinning:!!v&&!u,style:{display:"flex!important"}},e.default.createElement("div",{className:o.default.innerScreenshotContainer},e.default.createElement("div",{ref:le,style:Ae,onMouseDown:async e=>{const{setSwipeStart:t,setSwipeEnd:a,tapTickCoordinates:o,setSwipeStart1:r,setSwipeEnd1:s}=i,{POINTER_NAME:c,DURATION_1:u,DURATION_2:d,BUTTON:N}=l.DEFAULT_TAP;if(C===m)q({methodName:m,args:[{[c]:[{type:f,duration:u,x:re,y:ie},{type:p,button:N},{type:E,duration:d},{type:y,button:N}]}]});else if(C===O)console.log("inside the condition of the longpress!!"),setTimeout(()=>{L(I)},2e3);else if(C===I)await Ne();else if(C===h)console.log("inside the double tap function!!!"),setTimeout(()=>{L(A)},1e3);else if(C===A)await xe();else if(C===S)console.log("inside the drage and drop condition value!!!!!!"),k?F||(a(re,ie),he({x:re,y:ie})):t(re,ie);else if(W)o(re,ie);else if(C===T)k?F||(a(re,ie),await n.default.delay(500),await Oe({x:re,y:ie})):t(re,ie);else if(C===_)k?F?G?j||(s(re,ie),await n.default.delay(500),await ge({x:re,y:ie},ye)):r(re,ie):(a(re,ie),await n.default.delay(500),pe({x:re,y:ie})):t(re,ie);else if(C===x)setTimeout(()=>{L(g)},1e3),i.selectedElement&&ee(i.selectedElement);else if(C===g)k?F||(a(re,ie),await n.default.delay(500),await Se({x:re,y:ie})):t(re,ie);else if(C===D)console.log("inside the file upload condition!!!!!!!!!"),setTimeout(()=>{L(w)},1e3);else if(C===w)console.log("inside the select file condition!!!!!!!!!"),await me();else if(C===R){let e="",t={};i.selectedElement&&(t={expected_value:e=i.selectedElement.attributes.text,xpath:i.selectedElement.xpath}),await _e(t)}else C===b?await M.client.takeScreenshot():C===P&&(console.log("🚀 ~ file: Screenshot.js:201 ~ handleScreenshotClick ~ e:",e),k||(oe(!0),ae([]),await Te(e),t(re,ie)))},onMouseMove:Ie,onMouseOut:()=>{se(null),ce(null)},onDragOver:e=>{e.preventDefault()},onDrop:e=>{const{offsetX:t,offsetY:a}=e.nativeEvent,n=t*H,o=a*H,l=Math.round(n),r=Math.round(o);console.log("Drop position:",{x:l,y:r}),se(l),ce(r),ae([]),oe(!1),setTimeout(async()=>{await he({x:l,y:r})},1e3)},className:o.default.screenshotBox},C!==N&&e.default.createElement("div",{className:o.default.coordinatesContainer},e.default.createElement("p",null,K("xCoordinate",{x:re})),e.default.createElement("p",null,K("yCoordinate",{y:ie}))),De&&e.default.createElement(a.Tooltip,{open:!0,title:De,placement:"topLeft"},Re),!De&&Re,C===N&&le.current&&e.default.createElement(t.default,d({},i,{containerEl:le.current})),C===x&&le.current&&e.default.createElement(t.default,d({},i,{containerEl:le.current})),C===h&&le.current&&e.default.createElement(t.default,d({},i,{containerEl:le.current})),C===O&&le.current&&e.default.createElement(t.default,d({},i,{containerEl:le.current})),C===R&&le.current&&e.default.createElement(t.default,d({},i,{containerEl:le.current})),C===D&&le.current&&e.default.createElement(t.default,d({},i,{containerEl:le.current})),C===T&&e.default.createElement("svg",{className:o.default.swipeSvg},k&&!F&&e.default.createElement("circle",{cx:k.x/H,cy:k.y/H}),k&&F&&e.default.createElement("line",{x1:k.x/H,y1:k.y/H,x2:F.x/H,y2:F.y/H})),C===P&&e.default.createElement("svg",{className:o.default.swipeSvg},k&&ne&&te.map((t,a)=>e.default.createElement("circle",{key:a,cx:t.x/H,cy:t.y/H}))),C===g&&e.default.createElement("svg",{className:o.default.swipeSvg},k&&!F&&e.default.createElement("circle",{cx:k.x/H,cy:k.y/H}),k&&F&&e.default.createElement("line",{x1:k.x/H,y1:k.y/H,x2:F.x/H,y2:F.y/H})),C===S&&e.default.createElement("svg",{className:o.default.swipeSvg},k&&!F&&e.default.createElement("circle",{cx:k.x/H,cy:k.y/H}),k&&F&&e.default.createElement("line",{x1:k.x/H,y1:k.y/H,x2:F.x/H,y2:F.y/H})),C===_&&e.default.createElement("svg",{className:o.default.swipeSvg},k&&!F&&e.default.createElement("circle",{cx:k.x/H,cy:k.y/H}),k&&F&&e.default.createElement("line",{x1:k.x/H,y1:k.y/H,x2:F.x/H,y2:F.y/H}),G&&!j&&e.default.createElement("circle",{cx:G.x/H,cy:G.y/H}),G&&j&&e.default.createElement("line",{x1:G.x/H,y1:G.y/H,x2:j.x/H,y2:j.y/H})),C===m&&e.default.createElement("div",{className:o.default.tapDiv}),$===l.INTERACTION_MODE.GESTURES&&be&&e.default.createElement("svg",{key:"gestureSVG",className:o.default.gestureSvg},be.map(t=>t.map((a,n)=>e.default.createElement(e.default.Fragment,{key:a.id},n>0&&e.default.createElement("line",{className:o.default[a.type],key:`${a.id}.line`,x1:t[n-1].x/H,y1:t[n-1].y/H,x2:a.x/H,y2:a.y/H,style:{stroke:a.color}}),e.default.createElement("circle",{className:o.default[`circle-${a.type}`],key:`${a.id}.circle`,cx:a.x/H,cy:a.y/H,style:a.type===U.FILLED?{fill:a.color}:{stroke:a.color}}))))))),M&&M.client.isAndroid&&e.default.createElement("div",{className:o.default["whole-btn"]},e.default.createElement(a.Tooltip,{title:K("Press Back Button")},e.default.createElement(a.Button,{id:"btnPressHomeButton",className:o.default["phone-btn1"],icon:e.default.createElement(r.IoChevronBackOutline,{className:o.default["custom-button-icon"]}),onClick:()=>q({methodName:"pressKeyCode",args:[4]})})),e.default.createElement(a.Tooltip,{title:K("Press Home Button")},e.default.createElement(a.Button,{id:"btnPressHomeButton",className:o.default["phone-btn2"],icon:e.default.createElement(s.BiCircle,{className:o.default["custom-button-icon"]}),onClick:()=>q({methodName:"pressKeyCode",args:[3]})})),e.default.createElement(a.Tooltip,{title:K("Press App Switch Button")},e.default.createElement(a.Button,{id:"btnPressHomeButton",className:o.default["phone-btn3"],icon:e.default.createElement(s.BiSquare,{className:o.default["custom-button-icon"]}),onClick:()=>q({methodName:"pressKeyCode",args:[187]})}))))};var L=M;exports.default=L;
},{"./HighlighterRects":"nUEu","./Inspector.css":"rCqx","./shared":"n676"}],"f1Ee":[function(require,module,exports) {
module.exports="testinglogo.3ef8e341.png";
...
},{"./Inspector.css":"rCqx","./shared":"n676","../AntdTypes":"uK2B","../../../../assets/images/testinglogo.png":"f1Ee","../../../../assets/images/hamburger.jpg":"SCrj"}],"lQeY":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=I(require("react")),t=require("lodash"),n=require("./shared"),a=require("antd"),l=S(require("./Screenshot")),s=S(require("./HeaderButtons")),i=S(require("./SelectedElement")),o=S(require("./Source")),r=S(require("./Inspector.css")),c=S(require("./RecordedActions")),d=S(require("./Commands")),u=S(require("./SavedGestures")),p=S(require("./GestureEditor")),h=S(require("./SessionInfo")),m=require("../../polyfills"),f=S(require("moment")),E=require("react-redux"),T=require("@ant-design/icons"),g=require("../AntdTypes");function S(e){return e&&e.__esModule?e:{default:e}}function y(e){if("function"!=typeof WeakMap)return null;var t=new WeakMap,n=new WeakMap;return(y=function(e){return e?n:t})(e)}function I(e,t){if(!t&&e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var n=y(t);if(n&&n.has(e))return n.get(e);var a={},l=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var s in e)if("default"!==s&&Object.prototype.hasOwnProperty.call(e,s)){var i=l?Object.getOwnPropertyDescriptor(e,s):null;i&&(i.get||i.set)?Object.defineProperty(a,s,i):a[s]=e[s]}return a.default=e,n&&n.set(e,a),a}function O(){return(O=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e}).apply(this,arguments)}const{SELECT:C,SWIPE:A,TAP:N,LONGPRESS:b,DRAG_AND_DROP:R,DOUBLE_TAP:v,ZOOMIN:B,SLIDE:w,FILE_UPLOAD:P,EXPECTED_VALUE:_,ROTATE:U,TAKE_SCREENSHOT:D,SCRATCH:M,HIDE_KEYBOARD:x,GET_DEVICE_TIME:k,GET_CLIPBOARD:j}=n.SCREENSHOT_INTERACTION_MODE,L=a.Button.Group,F=870,Y=610,q=500,W=1e3;function G(e){let t=document.createElement("a");t.setAttribute("href","data:application/xml;charset=utf-8,"+encodeURIComponent(e)),t.setAttribute("download","source.xml"),t.style.display="none",document.body.appendChild(t),t.click(),document.body.removeChild(t)}class H extends e.Component{constructor(){super(),this.didInitialResize=!1,this.state={scaleRatio:1,activeIndex:0,showPanel:!1,currentSelection:null,step_array:[],total_array:[]},this.screenAndSourceEl=null,this.lastScreenshot=null,this.screenshotEl=null,this.updateSourceTreeWidth=(0,t.debounce)(this.updateSourceTreeWidth.bind(this),50),this.updateScaleRatio=(0,t.debounce)(this.updateScaleRatio.bind(this),500),this.mjpegStreamCheckInterval=null}updateScaleRatio(){const e=this.screenshotEl.querySelector("img");this.setState({scaleRatio:this.props.windowSize.width/e.offsetWidth})}updateSourceTreeWidth(){if(!this.screenAndSourceEl)return;const e=this.screenAndSourceEl.querySelector("#screenshotContainer"),t=this.screenAndSourceEl.querySelector("#screenshotContainer img#screenshot");if(!t)return;const n=t.getBoundingClientRect(),a=e.getBoundingClientRect();if(e.style.flexBasis=`${n.width}px`,n.height<a.height){const t=a.height/n.height*n.width;e.style.maxWidth=t>q?`${q}px`:`${t}px`}else n.width<a.width&&(e.style.maxWidth=`${n.width}px`);this.updateScaleRatio()}componentDidMount(){const e=window.innerHeight,t=window.innerWidth,n=e<Y||t<F;if(!this.didInitialResize&&n){const n=t<F?F:t,a=e<Y?Y:e;window.resizeTo(n,a)}this.didInitialResize=!0,console.log("props in the inspector",this.props),this.props.applyClientMethod({methodName:"getPageSource",ignoreResult:!0}),this.props.getSavedActionFramework(),this.props.runKeepAliveLoop(),window.addEventListener("resize",this.updateSourceTreeWidth),this.props.setSessionTime(Date.now()),this.props.mjpegScreenshotUrl&&(this.mjpegStreamCheckInterval=setInterval(this.checkMjpegStream.bind(this),W))}async checkMjpegStream(){const{mjpegScreenshotUrl:e,isAwaitingMjpegStream:t,setAwaitingMjpegStream:n}=this.props,a=new Image;a.src=e;let l=!1;try{await a.decode(),l=!0}catch(s){}l&&t?(n(!1),this.updateSourceTreeWidth()):l||t||n(!0)}componentDidUpdate(){const{screenshot:e}=this.props;e!==this.lastScreenshot&&(this.updateSourceTreeWidth(),this.lastScreenshot=e)}componentWillUnmount(){this.mjpegStreamCheckInterval&&(clearInterval(this.mjpegStreamCheckInterval),this.mjpegStreamCheckInterval=null)}handlePanel(e){this.setState({showPanel:!this.state.showPanel})}screenshotInteractionChange(e,t){const{selectScreenshotInteractionMode:n,clearSwipeAction:a}=this.props;a(),n(e),this.setState({currentSelection:t})}setActiveIndex(e){this.setState({activeIndex:e})}async hideKeyboard(){const{driver:e,screenshotInteractionMode:t}=this.props;e.client.hideKeyboard(),console.log("hide keyboard^^^^^^^^^^^^^^^^"),this.props.applyClientMethod({methodName:"getPageSource",ignoreResult:!0});let n={session_id:e.sessionId,"step-name":"hideKeyboard"};console.log("🚀 ~ file: Inspector.js:219 ~ Inspector ~ hideKeyboard ~ postdata:",n),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)}).then(e=>{console.log("API response:",e),n.response=e}).catch(e=>{console.error("API error:",e)})}async getDeviceTime(){const{driver:e}=this.props,t=await e.client.getDeviceTime();console.log("get device timeeeeeeeeeeeeeeeeee",t);const n=f.default.utc(t).utcOffset("+05:30").format("YYYY-MM-DD HH:mm:ss");let a={session_id:e.sessionId,"step-name":"getDeviceTime"};console.log("🚀 ~ file: Inspector.js:219 ~ Inspector ~ getDeviceTime ~ postdata:",a),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}).then(e=>{console.log("API response:",e),a.response=e}).catch(e=>{console.error("API error:",e)}),alert(n)}render(){const{screenshot:t,screenshotError:o,selectedElement:m={},quitSession:f,showRecord:E,screenshotInteractionMode:S,visibleCommandMethod:y,selectedInteractionMode:I,selectInteractionMode:L,setVisibleCommandResult:F,showKeepAlivePrompt:Y,keepSessionAlive:q,sourceXML:W,t:G,visibleCommandResult:H,mjpegScreenshotUrl:z,isAwaitingMjpegStream:K,toggleShowCentroids:J,showCentroids:V,isGestureEditorVisible:$,toggleShowAttributes:X,isSourceRefreshOn:Z,applyClientMethod:Q}=this.props,{path:ee}=m,{driver:te}=this.props,{flow_steps:ne}=this.props;ne&&(console.log("🚀 ~ file: Inspector.js:210 ~ Inspector ~ render ~ flow_steps:",ne),this.state.total_array=ne.steps.steps),console.log("driver for iddddddd",te.sessionId);const ae=t&&!o||z&&(!Z||!K);let le=e.default.createElement("div",{className:r.default["screenshot-controls"]},e.default.createElement(a.Tooltip,{title:G(V?"Hide Element Handles":"Show Element Handles"),placement:"topRight"},e.default.createElement(a.Switch,{checkedChildren:e.default.createElement(T.CheckCircleOutlined,null),unCheckedChildren:e.default.createElement(T.CloseCircleOutlined,null),defaultChecked:!1,onChange:()=>J(),disabled:$,style:{width:"40px"}})),e.default.createElement(a.Button,{icon:e.default.createElement(T.BarsOutlined,null),onClick:()=>this.handlePanel(this.state.showPanel)}),ae&&e.default.createElement("div",null,e.default.createElement("div",{onMouseOver:()=>this.setActiveIndex(1),onMouseOut:()=>this.setActiveIndex(0),style:{textAlign:"center",padding:"5px",borderBottom:"1px solid grey",position:"relative",cursor:"pointer"}},e.default.createElement(T.HeatMapOutlined,{style:{fontSize:"20px"}}),e.default.createElement("div",null,"Actions"),1===this.state.activeIndex&&e.default.createElement("div",{style:{display:"flex",flexDirection:"column",position:"absolute",zIndex:"999",left:"100%",top:"10%"}},e.default.createElement(a.Button,{icon:e.default.createElement(T.SelectOutlined,null),onClick:()=>{this.screenshotInteractionChange(C,"Select Elements")},type:S===C?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Select Elements")),e.default.createElement(a.Button,{icon:e.default.createElement(T.SwapRightOutlined,null),onClick:()=>{this.screenshotInteractionChange(A,"Swipe by coordinates")},type:S===A?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Swipe By Coordinates")),e.default.createElement(a.Button,{icon:e.default.createElement(T.ScanOutlined,null),onClick:()=>{this.screenshotInteractionChange(N,"Tap by coordinates")},type:S===N?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Tap By Coordinates")),e.default.createElement(a.Button,{icon:e.default.createElement(T.InfoOutlined,null),onClick:()=>{this.screenshotInteractionChange(b,"Longpress")},type:S===b?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"LongPress")),e.default.createElement(a.Button,{icon:e.default.createElement(T.DragOutlined,null),onClick:()=>{this.screenshotInteractionChange(R,"Drag & Drop")},type:S===R?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Drag & Drop")),e.default.createElement(a.Button,{icon:e.default.createElement(T.UpCircleOutlined,null),onClick:()=>{this.screenshotInteractionChange(v,"Double tap")},type:S===v?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,className:r.default.user_actions},e.default.createElement("span",null,"Double Tap")),e.default.createElement(a.Button,{icon:e.default.createElement(T.ShrinkOutlined,null),onClick:()=>{this.screenshotInteractionChange(B,"Zoom")},type:S===B?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Zoom")),e.default.createElement(a.Button,{icon:e.default.createElement(T.SlidersOutlined,null),onClick:()=>{this.screenshotInteractionChange(w,"Slider")},type:S===w?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Slider")))),e.default.createElement("div",{onMouseOver:()=>this.setActiveIndex(2),onMouseOut:()=>this.setActiveIndex(0),style:{textAlign:"center",padding:"5px",borderBottom:"1px solid grey",position:"relative",cursor:"pointer"}},e.default.createElement(T.EditOutlined,{style:{fontSize:"20px"}}),e.default.createElement("div",null,"Assertions"),2===this.state.activeIndex&&e.default.createElement("div",{style:{display:"flex",flexDirection:"column",position:"absolute",zIndex:"999",left:"100%",top:"10%"}},e.default.createElement(a.Button,{className:r.default.user_actions,icon:e.default.createElement(T.FileAddOutlined,null),onClick:async()=>{if(S===P){this.screenshotInteractionChange(null,null);let e={session_id:te.sessionId,"step-name":"select_file",status:"done"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)})}else this.screenshotInteractionChange(P,"File Upload")},type:S===P?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$},e.default.createElement("span",null,"File Upload")),e.default.createElement(a.Button,{icon:e.default.createElement(T.DollarOutlined,null),onClick:()=>{this.screenshotInteractionChange(_,"Expected Value")},type:S===_?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Expected value")),e.default.createElement(a.Button,{icon:e.default.createElement(T.FundProjectionScreenOutlined,null),onClick:()=>{this.screenshotInteractionChange(D,"Take screenshot")},type:S===D?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Take Screenshot")),e.default.createElement(a.Button,{icon:e.default.createElement(T.DollarOutlined,null),onClick:()=>{this.screenshotInteractionChange(M,"Scratch")},type:S===M?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Scratch")),e.default.createElement(a.Button,{icon:e.default.createElement(T.CaretDownOutlined,null),onClick:async()=>{this.screenshotInteractionChange(x,"Hide keyword"),this.hideKeyboard();let e={session_id:te.sessionId,"step-name":"steps"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await Q({methodName:"getPageSource"})},type:S===x?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Hide Keyboard")),e.default.createElement(a.Button,{icon:e.default.createElement(T.FieldTimeOutlined,null),onClick:async()=>{this.screenshotInteractionChange(k,"Get Device Time"),this.getDeviceTime();let e={session_id:te.sessionId,"step-name":"steps"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await Q({methodName:"getPageSource"})},type:S===k?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Get Device Time")),e.default.createElement(a.Button,{icon:e.default.createElement(T.PaperClipOutlined,null),onClick:async()=>{this.screenshotInteractionChange(j,"Get clipboard"),await Q({methodName:"getPageSource"})},type:S===j?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Get clipboard")),e.default.createElement(a.Button,{icon:e.default.createElement(T.RotateRightOutlined,null),onClick:async()=>{await te.client.setOrientation("LANDSCAPE")},type:S===U?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Rotate")),e.default.createElement(a.Button,{icon:e.default.createElement(T.NotificationOutlined,null),onClick:async()=>{await te.client.openNotifications();let e={session_id:te.sessionId,"step-name":"notification"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)});let t={session_id:te.sessionId,"step-name":"steps"};console.log("🚀 ~ file: Inspector.js:440 ~ Inspector ~ onClick={async ~ driver.sessionId:",te.sessionId),await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await Q({methodName:"getPageSource"})},type:S===U?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Open Notifications")),this.state.isInput?e.default.createElement("div",null,e.default.createElement(a.Input,{placeholder:"enter bundle id",onChange:e=>this.setState({inputBundleId:e.target.value})}),e.default.createElement(a.Button,{onClick:async()=>{await te.client.activateApp(this.state.inputBundleId);let e={session_id:te.sessionId,"step-name":"switch_app",bundle_id:this.state.inputBundleId};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then(e=>{console.log("API response:",e)}).catch(e=>{console.error("API error:",e)});let t={session_id:te.sessionId,"step-name":"steps"};await fetch("https://apprecord.testing24x7.ai/appAction",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}).then(e=>e.json()).then(e=>{console.log("Response data:",e),this.setState({total_array:e.steps.steps})}).catch(e=>{console.log("🚀 ~ file: Inspector.js:901 ~ return ~ error:",e)}),await Q({methodName:"getPageSource"}),this.setState({isInput:!1,inputBundleId:""})},style:{backgroundColor:"blue"}},"Activate App"),e.default.createElement(a.Button,{icon:e.default.createElement(T.AimOutlined,null),onClick:async()=>{await te.client.resetApp()},disabled:$,className:r.default.user_actions}," ",e.default.createElement("span",null,"Reset App"))):e.default.createElement(a.Button,{icon:e.default.createElement(T.SwitcherOutlined,null),onClick:()=>this.setState({isInput:!0}),type:S===U?g.BUTTON.PRIMARY:g.BUTTON.DEFAULT,disabled:$,className:r.default.user_actions},e.default.createElement("span",null,"Switch App")))))),se=e.default.createElement("div",{className:r.default["inspector-main"],ref:e=>{this.screenAndSourceEl=e}},e.default.createElement("div",{id:"screenshotContainer",className:r.default["screenshot-container"],ref:e=>{this.screenshotEl=e}},le,ae&&e.default.createElement("div",{style:{display:"flex",flexDirection:"column"}},null!==this.state.currentSelection&&e.default.createElement("div",{style:{textAlign:"center"}},"Current Selection : ",this.state.currentSelection),e.default.createElement(l.default,O({},this.props,{scaleRatio:this.state.scaleRatio}))),o&&G("couldNotObtainScreenshot",{screenshotError:o}),!ae&&e.default.createElement(a.Spin,{size:"large",spinning:!0},e.default.createElement("div",{className:r.default.screenshotBox}))),e.default.createElement("div",{id:"sourceTreeContainer",className:r.default["interaction-tab-container"]},E&&e.default.createElement(c.default,this.props),e.default.createElement(a.Tabs,{activeKey:I,size:"small",onChange:e=>L(e),items:[{label:G("Source"),key:n.INTERACTION_MODE.SOURCE,children:e.default.createElement("div",{className:"action-row"},e.default.createElement("div",{style:{fontWeight:"bold",width:"9%"}},"FLOW TABLE:"),e.default.createElement("div",{style:{width:"100%",overflowX:"auto",overflowY:"auto"}},e.default.createElement("table",null,e.default.createElement("tr",null,e.default.createElement("th",null,"S No."),e.default.createElement("th",null,"Step"),e.default.createElement("th",null,"Step Name"),e.default.createElement("th",null,"Search By"),e.default.createElement("th",null,"Search By Value")),this.state.total_array&&this.state.total_array.map((t,n)=>e.default.createElement("tr",{key:n},e.default.createElement("td",null,n+1),e.default.createElement("td",null,t.step),e.default.createElement("td",null,t.step_name),e.default.createElement("td",null,t.search_by),e.default.createElement("td",null,t.search_by_value))))),e.default.createElement("div",{id:"selectedElementContainer",className:`${r.default["interaction-tab-container"]} ${r.default["element-detail-container"]} action-col`},e.default.createElement(a.Card,{title:e.default.createElement("span",null,e.default.createElement(T.TagOutlined,null)," ",G("selectedElement")),className:r.default["selected-element-card"]},ee&&e.default.createElement(i.default,this.props),!ee&&e.default.createElement("i",null,G("selectElementInSource")))))},{label:G("Commands"),key:n.INTERACTION_MODE.COMMANDS,children:e.default.createElement(a.Card,{title:e.default.createElement("span",null,e.default.createElement(T.ThunderboltOutlined,null)," ",G("Execute Commands")),className:r.default["interaction-tab-card"]},e.default.createElement(d.default,this.props))},{label:G("Gestures"),key:n.INTERACTION_MODE.GESTURES,children:$?e.default.createElement(a.Card,{title:e.default.createElement("span",null,e.default.createElement(T.HighlightOutlined,null)," ",G("Gesture Builder")),className:r.default["interaction-tab-card"]},e.default.createElement(p.default,this.props)):e.default.createElement(a.Card,{title:e.default.createElement("span",null,e.default.createElement(T.HighlightOutlined,null)," ",G("Saved Gestures")),className:r.default["interaction-tab-card"]},e.default.createElement(u.default,this.props))},{label:G("Session Information"),key:n.INTERACTION_MODE.SESSION_INFO,children:e.default.createElement(a.Card,{title:e.default.createElement("span",null,e.default.createElement(T.InfoCircleOutlined,null)," ",G("Session Information")),className:r.default["interaction-tab-card"]},e.default.createElement(h.default,this.props))}]})));return e.default.createElement("div",{className:r.default["inspector-container"]},e.default.createElement(s.default,this.props),se,e.default.createElement(a.Modal,{title:G("Session Inactive"),open:Y,onOk:()=>q(),onCancel:()=>f(),okText:G("Keep Session Running"),cancelText:G("Quit Session")},e.default.createElement("p",null,G("Your session is about to expire"))),e.default.createElement(a.Modal,{title:G("methodCallResult",{methodName:y}),open:!!H,onOk:()=>F(null),onCancel:()=>F(null)},e.default.createElement("pre",null,e.default.createElement("code",null,H))))}}exports.default=H;
...
>>>>>>> 8b9cf35cbb14a0b88886d90b15a1e3e44523235d
